 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(e){return e&&e._delegate?e._delegate:e}var Go=function(){function e(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}return e.prototype.setInstantiationMode=function(e){return this.instantiationMode=e,this},e.prototype.setMultipleInstances=function(e){return this.multipleInstances=e,this},e.prototype.setServiceProps=function(e){return this.serviceProps=e,this},e.prototype.setInstanceCreatedCallback=function(e){return this.onInstanceCreated=e,this},e}(),Xo=function(){function e(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.onInitCallbacks=new Map}return e.prototype.get=function(e){var t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){var n=new No;if(this.instancesDeferred.set(t,n),this.isInitialized(t)||this.shouldAutoInitialize())try{var r=this.getOrInitializeService({instanceIdentifier:t});r&&n.resolve(r)}catch(i){}}return this.instancesDeferred.get(t).promise},e.prototype.getImmediate=function(e){var t,n=this.normalizeInstanceIdentifier(null==e?void 0:e.identifier),r=null!==(t=null==e?void 0:e.optional)&&void 0!==t&&t;if(!this.isInitialized(n)&&!this.shouldAutoInitialize()){if(r)return null;throw Error("Service "+this.name+" is not available")}try{return this.getOrInitializeService({instanceIdentifier:n})}catch(i){if(r)return null;throw i}},e.prototype.getComponent=function(){return this.component},e.prototype.setComponent=function(e){var t,n;if(e.name!==this.name)throw Error("Mismatching Component "+e.name+" for Provider "+this.name+".");if(this.component)throw Error("Component for "+this.name+" has already been provided");if(this.component=e,this.shouldAutoInitialize()){if(function(e){return"EAGER"===e.instantiationMode}
/**
 * @license
 ...
 * limitations under the License.
 */
class Za{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){ka(e.idToken,"internal-error"),ka(void 0!==e.idToken,"internal-error"),ka(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=Ga(e);return ka(t,"internal-error"),ka(void 0!==t.exp,"internal-error"),ka(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return ka(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:r,expiresIn:i}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Hc.receivers=[];class Wc{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const r="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!r)throw new Error("connection_unavailable");let i,s;return new Promise(((o,a)=>{const c=Kc("",20);r.port1.start();const l=setTimeout((()=>{a(new Error("unsupported_event"))}),n);s={messageChannel:r,onMessage(e){const t=e;if(t.data.eventId===c)switch(t.data.status){case"ack":clearTimeout(l),i=setTimeout((()=>{a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(i),o(t.data.response);break;default:clearTimeout(l),clearTimeout(i),a(new Error("invalid_response"))}}},this.handlers.add(s),r.port1.addEventListener("message",s.onMessage),this.target.postMessage({eventType:e,eventId:c,data:t},[r.port2])})).finally((()=>{s&&this.removeMessageHandler(s)}))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xc(){return void 0!==Gc().WorkerGlobalScope&&"function"==typeof Gc().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const dl=new La(3e4,6e4);function fl(){const e=Gc().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function pl(e){return new Promise(((t,n)=>{var r,i,s;function o(){fl(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{fl(),n(Ia(e,"network-request-failed"))},timeout:dl.get()})}if(null===(i=null===(r=Gc().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Gc().gapi)||void 0===s?void 0:s.load)){const t=`__${"iframefcb"}${Math.floor(1e6*Math.random())}`;return Gc()[t]=()=>{gapi.load?o():n(Ia(e,"network-request-failed"))},hl(`https://apis.google.com/js/api.js?onload=${t}`)}o()}})).catch((e=>{throw gl=null,e}))}let gl=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const lu="raw",uu="base64",hu="base64url",du="data_url";class fu{constructor(e,t){this.data=e,this.contentType=t||null}}function pu(e,t){switch(e){case lu:return new fu(gu(t));case uu:case hu:return new fu(mu(e,t));case du:return new fu(function(e){const t=new yu(e);return t.base64?mu(uu,t.rest):function(e){let t;try{t=decodeURIComponent(e)}catch(n){throw Gl(du,"Malformed data URL.")}return gu(t)}(t.rest)}(t),new yu(t).contentType)}throw Hl()}function gu(e){const t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<=127)t.push(r);else if(r<=2047)t.push(192|r>>6,128|63&r);else if(55296==(64512&r)){if(n<e.length-1&&56320==(64512&e.charCodeAt(n+1))){r=65536|(1023&r)<<10|1023&e.charCodeAt(++n),t.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|63&r)}else t.push(239,191,189)}else 56320==(64512&r)?t.push(239,191,189):t.push(224|r>>12,128|r>>6&63,128|63&r)}return new Uint8Array(t)}function mu(e,t){switch(e){case uu:{const n=-1!==t.indexOf("-"),r=-1!==t.indexOf("_");if(n||r){throw Gl(e,"Invalid character '"+(n?"-":"_")+"' found: is it base64url encoded?")}break}case hu:{const n=-1!==t.indexOf("+"),r=-1!==t.indexOf("/");if(n||r){throw Gl(e,"Invalid character '"+(n?"+":"/")+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=atob(t)}catch(i){throw Gl(e,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class yu{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw Gl(du,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=function(e,t){if(!(e.length>=t.length))return!1;return e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function ju(e,t,n){return function(e,t,n){e._throwIfRoot("uploadBytes");const r=Du(e.storage,e._location,Iu(),new vu(t,!0),n);return e.storage.makeRequestWithTokens(r).then((e=>e.getPromise())).then((t=>({metadata:t,ref:e})))}(e=Wo(e),t,n)}function Bu(e){return Lu(e=Wo(e))}function qu(e){return Pu(e=Wo(e))}function $u(e,t){return Uu(e=Wo(e),t)}function zu(e=ya(),t){return fa(e=Wo(e),"storage-exp").getImmediate({identifier:t})}function Hu(e,{instanceIdentifier:t}){const n=e.getProvider("app-exp").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new Vu(n,r,i,new Yl,t,"9.0.0-beta.8")}da(new Go("storage-exp",Hu,"PUBLIC").setMultipleInstances(!0)),va("@firebase/storage","0.0.900-exp.8b4d7550f");
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class km{constructor(e,t=null,n=[],r=[],i=null,s="F",o=null,a=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=o,this.endAt=a,this.p=null,this.T=null,this.startAt,this.endAt}}function Am(e){return new km(e)}function Cm(e){return!Bg(e.limit)&&"F"===e.limitType}function Rm(e){return!Bg(e.limit)&&"L"===e.limitType}function Nm(e){const t=vg(e);if(null===t.p){t.p=[];const e=function(e){for(const t of e.filters)if(t.g())return t.field;return null}(t),n=function(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}(t);if(null!==e&&null===n)e.isKeyField()||t.p.push(new Em(e)),t.p.push(new Em(Og.keyField(),"asc"));else{let e=!1;for(const n of t.explicitOrderBy)t.p.push(n),n.field.isKeyField()&&(e=!0);if(!e){const e=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.p.push(new Em(Og.keyField(),e))}}}return t.p}function Om(e){const t=vg(e);if(!t.T)if("F"===t.limitType)t.T=am(t.path,t.collectionGroup,Nm(t),t.filters,t.limit,t.startAt,t.endAt);else{const e=[];for(const i of Nm(t)){const t="desc"===i.dir?"asc":"desc";e.push(new Em(i.field,t))}const n=t.endAt?new _m(t.endAt.position,!t.endAt.before):null,r=t.startAt?new _m(t.startAt.position,!t.startAt.before):null;t.T=am(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}return t.T}function Dm(e,t){return lm(Om(e),Om(t))&&e.limitType===t.limitType}function xm(e){return`${cm(Om(e))}|lt:${e.limitType}`}function Lm(e){return`Query(target=${function(e){let t=e.path.canonicalString();return null!==e.collectionGroup&&(t+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(t+=`, filters: [${e.filters.map((e=>{return`${(t=e).field.canonicalString()} ${t.op} ${Xg(t.value)}`;var t})).join(", ")}]`),Bg(e.limit)||(t+=", limit: "+e.limit),e.orderBy.length>0&&(t+=`, orderBy: [${e.orderBy.map((e=>{return`${(t=e).field.canonicalString()} (${t.dir})`;var t})).join(", ")}]`),e.startAt&&(t+=", startAt: "+bm(e.startAt)),e.endAt&&(t+=", endAt: "+bm(e.endAt)),`Target(${t})`}(Om(e))}; limitType=${e.limitType})`}function Pm(e,t){return t.isFoundDocument()&&function(e,t){const n=t.key.path;return null!==e.collectionGroup?t.key.hasCollectionId(e.collectionGroup)&&e.path.isPrefixOf(n):$g.isDocumentKey(e.path)?e.path.isEqual(n):e.path.isImmediateParentOf(n)}(e,t)&&function(e,t){for(const n of e.explicitOrderBy)if(!n.field.isKeyField()&&null===t.data.field(n.field))return!1;return!0}(e,t)&&function(e,t){for(const n of e.filters)if(!n.matches(t))return!1;return!0}(e,t)&&(r=t,!((n=e).startAt&&!Im(n.startAt,Nm(n),r)||n.endAt&&Im(n.endAt,Nm(n),r)));var n,r}function Mm(e){return(t,n)=>{let r=!1;for(const i of Nm(e)){const e=Um(i,t,n);if(0!==e)return e;r=r||i.field.isKeyField()}return 0}}function Um(e,t,n){const r=e.field.isKeyField()?$g.comparator(t.key,n.key):function(e,t,n){const r=t.data.field(e),i=n.data.field(e);return null!==r&&null!==i?Wg(r,i):mg()}(e.field,t,n);switch(e.dir){case"asc":return r;case"desc":return-1*r;default:return mg()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fm(e,t){if(e.I){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:qg(t)?"-0":t}}function Vm(e){return{integerValue:""+e}}function jm(e,t){return function(e){return"number"==typeof e&&Number.isInteger(e)&&!qg(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}(t)?Vm(t):Fm(e,t)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bm{constructor(){this._=void 0}}function qm(e,t,n){return e instanceof Hm?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&(n.fields.__previous_value__=t),{mapValue:n}}(n,t):e instanceof Km?Wm(e,t):e instanceof Gm?Xm(e,t):function(e,t){const n=zm(e,t),r=Ym(n)+Ym(e.A);return Yg(n)&&Yg(e.A)?Vm(r):Fm(e.R,r)}(e,t)}function $m(e,t,n){return e instanceof Km?Wm(e,t):e instanceof Gm?Xm(e,t):n}function zm(e,t){return e instanceof Qm?Yg(r=t)||(n=r)&&"doubleValue"in n?t:{integerValue:0}:null;var n,r}class Hm extends Bm{}class Km extends Bm{constructor(e){super(),this.elements=e}}function Wm(e,t){const n=Jm(t);for(const r of e.elements)n.some((e=>Hg(e,r)))||n.push(r);return{arrayValue:{values:n}}}class Gm extends Bm{constructor(e){super(),this.elements=e}}function Xm(e,t){let n=Jm(t);for(const r of e.elements)n=n.filter((e=>!Hg(e,r)));return{arrayValue:{values:n}}}class Qm extends Bm{constructor(e,t){super(),this.R=e,this.A=t}}function Ym(e){return Mg(e.integerValue||e.doubleValue)}function Jm(e){return Jg(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zm{constructor(e,t){this.field=e,this.transform=t}}class ey{constructor(e,t){this.version=e,this.transformResults=t}}class ty{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new ty}static exists(e){return new ty(void 0,e)}static updateTime(e){return new ty(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ny(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class ry{}function iy(e,t,n){var r;e instanceof ly?function(e,t,n){const r=e.value.clone(),i=dy(e.fieldTransforms,t,n.transformResults);r.setAll(i),t.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(e,t,n):e instanceof uy?function(e,t,n){if(!ny(e.precondition,t))return void t.convertToUnknownDocument(n.version);const r=dy(e.fieldTransforms,t,n.transformResults),i=t.data;i.setAll(hy(e)),i.setAll(r),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):(r=n,t.convertToNoDocument(r.version).setHasCommittedMutations())}function sy(e,t,n){var r;e instanceof ly?function(e,t,n){if(!ny(e.precondition,t))return;const r=e.value.clone(),i=fy(e.fieldTransforms,n,t);r.setAll(i),t.convertToFoundDocument(cy(t),r).setHasLocalMutations()}(e,t,n):e instanceof uy?function(e,t,n){if(!ny(e.precondition,t))return;const r=fy(e.fieldTransforms,n,t),i=t.data;i.setAll(hy(e)),i.setAll(r),t.convertToFoundDocument(cy(t),i).setHasLocalMutations()}(e,t,n):(r=t,ny(e.precondition,r)&&r.convertToNoDocument(Ig.min()))}function oy(e,t){let n=null;for(const r of e.fieldTransforms){const e=t.data.field(r.field),i=zm(r.transform,e||null);null!=i&&(null==n&&(n=rm.empty()),n.set(r.field,i))}return n||null}function ay(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,r=t.fieldTransforms,!!(void 0===n&&void 0===r||n&&r&&Eg(n,r,((e,t)=>function(e,t){return e.field.isEqual(t.field)&&(n=e.transform,r=t.transform,n instanceof Km&&r instanceof Km||n instanceof Gm&&r instanceof Gm?Eg(n.elements,r.elements,Hg):n instanceof Qm&&r instanceof Qm?Hg(n.A,r.A):n instanceof Hm&&r instanceof Hm);var n,r}(e,t))))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask)));var n,r}function cy(e){return e.isFoundDocument()?e.version:Ig.min()}class ly extends ry{constructor(e,t,n,r=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=r,this.type=0}}class uy extends ry{constructor(e,t,n,r,i=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}}function hy(e){const t=new Map;return e.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const r=e.data.field(n);t.set(n,r)}})),t}function dy(e,t,n){const r=new Map;yg(e.length===n.length);for(let i=0;i<n.length;i++){const s=e[i],o=s.transform,a=t.data.field(s.field);r.set(s.field,$m(o,a,n[i]))}return r}function fy(e,t,n){const r=new Map;for(const i of e){const e=i.transform,s=n.data.field(i.field);r.set(i.field,qm(e,s,t))}return r}class py extends ry{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}}class gy extends ry{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class my{constructor(e){this.count=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var yy,vy;function wy(e){if(void 0===e)return fg("GRPC error has no .code"),cg.UNKNOWN;switch(e){case yy.OK:return cg.OK;case yy.CANCELLED:return cg.CANCELLED;case yy.UNKNOWN:return cg.UNKNOWN;case yy.DEADLINE_EXCEEDED:return cg.DEADLINE_EXCEEDED;case yy.RESOURCE_EXHAUSTED:return cg.RESOURCE_EXHAUSTED;case yy.INTERNAL:return cg.INTERNAL;case yy.UNAVAILABLE:return cg.UNAVAILABLE;case yy.UNAUTHENTICATED:return cg.UNAUTHENTICATED;case yy.INVALID_ARGUMENT:return cg.INVALID_ARGUMENT;case yy.NOT_FOUND:return cg.NOT_FOUND;case yy.ALREADY_EXISTS:return cg.ALREADY_EXISTS;case yy.PERMISSION_DENIED:return cg.PERMISSION_DENIED;case yy.FAILED_PRECONDITION:return cg.FAILED_PRECONDITION;case yy.ABORTED:return cg.ABORTED;case yy.OUT_OF_RANGE:return cg.OUT_OF_RANGE;case yy.UNIMPLEMENTED:return cg.UNIMPLEMENTED;case yy.DATA_LOSS:return cg.DATA_LOSS;default:return mg()}}(vy=yy||(yy={}))[vy.OK=0]="OK",vy[vy.CANCELLED=1]="CANCELLED",vy[vy.UNKNOWN=2]="UNKNOWN",vy[vy.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",vy[vy.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",vy[vy.NOT_FOUND=5]="NOT_FOUND",vy[vy.ALREADY_EXISTS=6]="ALREADY_EXISTS",vy[vy.PERMISSION_DENIED=7]="PERMISSION_DENIED",vy[vy.UNAUTHENTICATED=16]="UNAUTHENTICATED",vy[vy.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",vy[vy.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",vy[vy.ABORTED=10]="ABORTED",vy[vy.OUT_OF_RANGE=11]="OUT_OF_RANGE",vy[vy.UNIMPLEMENTED=12]="UNIMPLEMENTED",vy[vy.INTERNAL=13]="INTERNAL",vy[vy.UNAVAILABLE=14]="UNAVAILABLE",vy[vy.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class _y{constructor(e,t){this.comparator=e,this.root=t||Ey.EMPTY}insert(e,t){return new _y(this.comparator,this.root.insert(e,t,this.comparator).copy(null,null,Ey.BLACK,null,null))}remove(e){return new _y(this.comparator,this.root.remove(e,this.comparator).copy(null,null,Ey.BLACK,null,null))}get(e){let t=this.root;for(;!t.isEmpty();){const n=this.comparator(e,t.key);if(0===n)return t.value;n<0?t=t.left:n>0&&(t=t.right)}return null}indexOf(e){let t=0,n=this.root;for(;!n.isEmpty();){const r=this.comparator(e,n.key);if(0===r)return t+n.left.size;r<0?n=n.left:(t+=n.left.size+1,n=n.right)}return-1}isEmpty(){return this.root.isEmpty()}get size(){return this.root.size}minKey(){return this.root.minKey()}maxKey(){return this.root.maxKey()}inorderTraversal(e){return this.root.inorderTraversal(e)}forEach(e){this.inorderTraversal(((t,n)=>(e(t,n),!1)))}toString(){const e=[];return this.inorderTraversal(((t,n)=>(e.push(`${t}:${n}`),!1))),`{${e.join(", ")}}`}reverseTraversal(e){return this.root.reverseTraversal(e)}getIterator(){return new by(this.root,null,this.comparator,!1)}getIteratorFrom(e){return new by(this.root,e,this.comparator,!1)}getReverseIterator(){return new by(this.root,null,this.comparator,!0)}getReverseIteratorFrom(e){return new by(this.root,e,this.comparator,!0)}}class by{constructor(e,t,n,r){this.isReverse=r,this.nodeStack=[];let i=1;for(;!e.isEmpty();)if(i=t?n(e.key,t):1,r&&(i*=-1),i<0)e=this.isReverse?e.left:e.right;else{if(0===i){this.nodeStack.push(e);break}this.nodeStack.push(e),e=this.isReverse?e.right:e.left}}getNext(){let e=this.nodeStack.pop();const t={key:e.key,value:e.value};if(this.isReverse)for(e=e.left;!e.isEmpty();)this.nodeStack.push(e),e=e.right;else for(e=e.right;!e.isEmpty();)this.nodeStack.push(e),e=e.left;return t}hasNext(){return this.nodeStack.length>0}peek(){if(0===this.nodeStack.length)return null;const e=this.nodeStack[this.nodeStack.length-1];return{key:e.key,value:e.value}}}class Ey{constructor(e,t,n,r,i){this.key=e,this.value=t,this.color=null!=n?n:Ey.RED,this.left=null!=r?r:Ey.EMPTY,this.right=null!=i?i:Ey.EMPTY,this.size=this.left.size+1+this.right.size}copy(e,t,n,r,i){return new Ey(null!=e?e:this.key,null!=t?t:this.value,null!=n?n:this.color,null!=r?r:this.left,null!=i?i:this.right)}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min(){return this.left.isEmpty()?this:this.left.min()}minKey(){return this.min().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,n){let r=this;const i=n(e,r.key);return r=i<0?r.copy(null,null,null,r.left.insert(e,t,n),null):0===i?r.copy(null,t,null,null,null):r.copy(null,null,null,null,r.right.insert(e,t,n)),r.fixUp()}removeMin(){if(this.left.isEmpty())return Ey.EMPTY;let e=this;return e.left.isRed()||e.left.left.isRed()||(e=e.moveRedLeft()),e=e.copy(null,null,null,e.left.removeMin(),null),e.fixUp()}remove(e,t){let n,r=this;if(t(e,r.key)<0)r.left.isEmpty()||r.left.isRed()||r.left.left.isRed()||(r=r.moveRedLeft()),r=r.copy(null,null,null,r.left.remove(e,t),null);else{if(r.left.isRed()&&(r=r.rotateRight()),r.right.isEmpty()||r.right.isRed()||r.right.left.isRed()||(r=r.moveRedRight()),0===t(e,r.key)){if(r.right.isEmpty())return Ey.EMPTY;n=r.right.min(),r=r.copy(n.key,n.value,null,null,r.right.removeMin())}r=r.copy(null,null,null,null,r.right.remove(e,t))}return r.fixUp()}isRed(){return this.color}fixUp(){let e=this;return e.right.isRed()&&!e.left.isRed()&&(e=e.rotateLeft()),e.left.isRed()&&e.left.left.isRed()&&(e=e.rotateRight()),e.left.isRed()&&e.right.isRed()&&(e=e.colorFlip()),e}moveRedLeft(){let e=this.colorFlip();return e.right.left.isRed()&&(e=e.copy(null,null,null,null,e.right.rotateRight()),e=e.rotateLeft(),e=e.colorFlip()),e}moveRedRight(){let e=this.colorFlip();return e.left.left.isRed()&&(e=e.rotateRight(),e=e.colorFlip()),e}rotateLeft(){const e=this.copy(null,null,Ey.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight(){const e=this.copy(null,null,Ey.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth(){const e=this.check();return Math.pow(2,e)<=this.size+1}check(){if(this.isRed()&&this.left.isRed())throw mg();if(this.right.isRed())throw mg();const e=this.left.check();if(e!==this.right.check())throw mg();return e+(this.isRed()?0:1)}}Ey.EMPTY=null,Ey.RED=!0,Ey.BLACK=!1,Ey.EMPTY=new class{constructor(){this.size=0}get key(){throw mg()}get value(){throw mg()}get color(){throw mg()}get left(){throw mg()}get right(){throw mg()}copy(e,t,n,r,i){return this}insert(e,t,n){return new Ey(e,t)}remove(e,t){return this}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}isRed(){return!1}checkMaxDepth(){return!0}check(){return 0}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ty{constructor(e){this.comparator=e,this.data=new _y(this.comparator)}has(e){return null!==this.data.get(e)}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(e){return this.data.indexOf(e)}forEach(e){this.data.inorderTraversal(((t,n)=>(e(t),!1)))}forEachInRange(e,t){const n=this.data.getIteratorFrom(e[0]);for(;n.hasNext();){const r=n.getNext();if(this.comparator(r.key,e[1])>=0)return;t(r.key)}}forEachWhile(e,t){let n;for(n=void 0!==t?this.data.getIteratorFrom(t):this.data.getIterator();n.hasNext();)if(!e(n.getNext().key))return}firstAfterOrEqual(e){const t=this.data.getIteratorFrom(e);return t.hasNext()?t.getNext().key:null}getIterator(){return new Iy(this.data.getIterator())}getIteratorFrom(e){return new Iy(this.data.getIteratorFrom(e))}add(e){return this.copy(this.data.remove(e).insert(e,!0))}delete(e){return this.has(e)?this.copy(this.data.remove(e)):this}isEmpty(){return this.data.isEmpty()}unionWith(e){let t=this;return t.size<e.size&&(t=e,e=this),e.forEach((e=>{t=t.add(e)})),t}isEqual(e){if(!(e instanceof Ty))return!1;if(this.size!==e.size)return!1;const t=this.data.getIterator(),n=e.data.getIterator();for(;t.hasNext();){const e=t.getNext().key,r=n.getNext().key;if(0!==this.comparator(e,r))return!1}return!0}toArray(){const e=[];return this.forEach((t=>{e.push(t)})),e}toString(){const e=[];return this.forEach((t=>e.push(t))),"SortedSet("+e.toString()+")"}copy(e){const t=new Ty(this.comparator);return t.data=e,t}}class Iy{constructor(e){this.iter=e}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sy=new _y($g.comparator);function ky(){return Sy}const Ay=new _y($g.comparator);function Cy(){return Ay}const Ry=new _y($g.comparator);const Ny=new Ty($g.comparator);function Oy(...e){let t=Ny;for(const n of e)t=t.add(n);return t}const Dy=new Ty(bg);function xy(){return Dy}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ly{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t){const n=new Map;return n.set(e,Py.createSynthesizedTargetChangeForCurrentChange(e,t)),new Ly(Ig.min(),n,xy(),ky(),Oy())}}class Py{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t){return new Py(xg.EMPTY_BYTE_STRING,t,Oy(),Oy(),Oy())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class My{constructor(e,t,n,r){this.P=e,this.removedTargetIds=t,this.key=n,this.v=r}}class Uy{constructor(e,t){this.targetId=e,this.V=t}}class Fy{constructor(e,t,n=xg.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class Vy{constructor(){this.S=0,this.D=qy(),this.C=xg.EMPTY_BYTE_STRING,this.N=!1,this.k=!0}get current(){return this.N}get resumeToken(){return this.C}get $(){return 0!==this.S}get O(){return this.k}F(e){e.approximateByteSize()>0&&(this.k=!0,this.C=e)}M(){let e=Oy(),t=Oy(),n=Oy();return this.D.forEach(((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:mg()}})),new Py(this.C,this.N,e,t,n)}L(){this.k=!1,this.D=qy()}B(e,t){this.k=!0,this.D=this.D.insert(e,t)}U(e){this.k=!0,this.D=this.D.remove(e)}q(){this.S+=1}K(){this.S-=1}j(){this.k=!0,this.N=!0}}class jy{constructor(e){this.W=e,this.G=new Map,this.H=ky(),this.J=By(),this.Y=new Ty(bg)}X(e){for(const t of e.P)e.v&&e.v.isFoundDocument()?this.Z(t,e.v):this.tt(t,e.key,e.v);for(const t of e.removedTargetIds)this.tt(t,e.key,e.v)}et(e){this.forEachTarget(e,(t=>{const n=this.nt(t);switch(e.state){case 0:this.st(t)&&n.F(e.resumeToken);break;case 1:n.K(),n.$||n.L(),n.F(e.resumeToken);break;case 2:n.K(),n.$||this.removeTarget(t);break;case 3:this.st(t)&&(n.j(),n.F(e.resumeToken));break;case 4:this.st(t)&&(this.it(t),n.F(e.resumeToken));break;default:mg()}}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.G.forEach(((e,n)=>{this.st(n)&&t(n)}))}rt(e){const t=e.targetId,n=e.V.count,r=this.ot(t);if(r){const e=r.target;if(um(e))if(0===n){const n=new $g(e.path);this.tt(t,n,sm.newNoDocument(n,Ig.min()))}else yg(1===n);else this.ct(t)!==n&&(this.it(t),this.Y=this.Y.add(t))}}ut(e){const t=new Map;this.G.forEach(((n,r)=>{const i=this.ot(r);if(i){if(n.current&&um(i.target)){const t=new $g(i.target.path);null!==this.H.get(t)||this.at(r,t)||this.tt(r,t,sm.newNoDocument(t,e))}n.O&&(t.set(r,n.M()),n.L())}}));let n=Oy();this.J.forEach(((e,t)=>{let r=!0;t.forEachWhile((e=>{const t=this.ot(e);return!t||2===t.purpose||(r=!1,!1)})),r&&(n=n.add(e))}));const r=new Ly(e,t,this.Y,this.H,n);return this.H=ky(),this.J=By(),this.Y=new Ty(bg),r}Z(e,t){if(!this.st(e))return;const n=this.at(e,t.key)?2:0;this.nt(e).B(t.key,n),this.H=this.H.insert(t.key,t),this.J=this.J.insert(t.key,this.ht(t.key).add(e))}tt(e,t,n){if(!this.st(e))return;const r=this.nt(e);this.at(e,t)?r.B(t,1):r.U(t),this.J=this.J.insert(t,this.ht(t).delete(e)),n&&(this.H=this.H.insert(t,n))}removeTarget(e){this.G.delete(e)}ct(e){const t=this.nt(e).M();return this.W.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}q(e){this.nt(e).q()}nt(e){let t=this.G.get(e);return t||(t=new Vy,this.G.set(e,t)),t}ht(e){let t=this.J.get(e);return t||(t=new Ty(bg),this.J=this.J.insert(e,t)),t}st(e){const t=null!==this.ot(e);return t||dg("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.G.get(e);return t&&t.$?null:this.W.lt(e)}it(e){this.G.set(e,new Vy),this.W.getRemoteKeysForTarget(e).forEach((t=>{this.tt(e,t,null)}))}at(e,t){return this.W.getRemoteKeysForTarget(e).has(t)}}function By(){return new _y($g.comparator)}function qy(){return new _y($g.comparator)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $y={asc:"ASCENDING",desc:"DESCENDING"},zy={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"};class Hy{constructor(e,t){this.databaseId=e,this.I=t}}function Ky(e,t){return e.I?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Wy(e,t){return e.I?t.toBase64():t.toUint8Array()}function Gy(e,t){return Ky(e,t.toTimestamp())}function Xy(e){return yg(!!e),Ig.fromTimestamp(function(e){const t=Pg(e);return new Tg(t.seconds,t.nanos)}(e))}function Qy(e,t){return(n=e,new Rg(["projects",n.projectId,"databases",n.database])).child("documents").child(t).canonicalString();var n}function Yy(e){const t=Rg.fromString(e);return yg(yv(t)),t}function Jy(e,t){return Qy(e.databaseId,t.path)}function Zy(e,t){const n=Yy(t);if(n.get(1)!==e.databaseId.projectId)throw new lg(cg.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new lg(cg.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new $g(nv(n))}function ev(e,t){return Qy(e.databaseId,t)}function tv(e){return new Rg(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function nv(e){return yg(e.length>4&&"documents"===e.get(4)),e.popFirst(5)}function rv(e,t,n){return{name:Jy(e,t),fields:n.value.mapValue.fields}}function iv(e,t){return{documents:[ev(e,t.path)]}}function sv(e,t){const n={structuredQuery:{}},r=t.path;null!==t.collectionGroup?(n.parent=ev(e,r),n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(n.parent=ev(e,r.popLast()),n.structuredQuery.from=[{collectionId:r.lastSegment()}]);const i=function(e){if(0===e.length)return;const t=e.map((e=>function(e){if("=="===e.op){if(em(e.value))return{unaryFilter:{field:dv(e.field),op:"IS_NAN"}};if(Zg(e.value))return{unaryFilter:{field:dv(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(em(e.value))return{unaryFilter:{field:dv(e.field),op:"IS_NOT_NAN"}};if(Zg(e.value))return{unaryFilter:{field:dv(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:dv(e.field),op:hv(e.op),value:e.value}}}(e)));return 1===t.length?t[0]:{compositeFilter:{op:"AND",filters:t}}}(t.filters);i&&(n.structuredQuery.where=i);const s=function(e){if(0!==e.length)return e.map((e=>{return{field:dv((t=e).field),direction:uv(t.dir)};var t}))}(t.orderBy);s&&(n.structuredQuery.orderBy=s);const o=(a=e,c=t.limit,a.I||Bg(c)?c:{value:c});var a,c;return null!==o&&(n.structuredQuery.limit=o),t.startAt&&(n.structuredQuery.startAt=cv(t.startAt)),t.endAt&&(n.structuredQuery.endAt=cv(t.endAt)),n}function ov(e){let t=function(e){const t=Yy(e);return 4===t.length?Rg.emptyPath():nv(t)}(e.parent);const n=e.structuredQuery,r=n.from?n.from.length:0;let i=null;if(r>0){yg(1===r);const e=n.from[0];e.allDescendants?i=e.collectionId:t=t.child(e.collectionId)}let s=[];n.where&&(s=av(n.where));let o=[];n.orderBy&&(o=n.orderBy.map((e=>{return new Em(fv((t=e).field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(t.direction));var t})));let a=null;n.limit&&(a=function(e){let t;return t="object"==typeof e?e.value:e,Bg(t)?null:t}(n.limit));let c=null;n.startAt&&(c=lv(n.startAt));let l=null;return n.endAt&&(l=lv(n.endAt)),function(e,t,n,r,i,s,o,a){return new km(e,t,n,r,i,s,o,a)}(t,i,o,s,a,"F",c,l)}function av(e){return e?void 0!==e.unaryFilter?[gv(e)]:void 0!==e.fieldFilter?[pv(e)]:void 0!==e.compositeFilter?e.compositeFilter.filters.map((e=>av(e))).reduce(((e,t)=>e.concat(t))):mg():[]}function cv(e){return{before:e.before,values:e.position}}function lv(e){const t=!!e.before,n=e.values||[];return new _m(n,t)}function uv(e){return $y[e]}function hv(e){return zy[e]}function dv(e){return{fieldPath:e.canonicalString()}}function fv(e){return Og.fromServerFormat(e.fieldPath)}function pv(e){return hm.create(fv(e.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":default:return mg()}}(e.fieldFilter.op),e.fieldFilter.value)}function gv(e){switch(e.unaryFilter.op){case"IS_NAN":const t=fv(e.unaryFilter.field);return hm.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=fv(e.unaryFilter.field);return hm.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=fv(e.unaryFilter.field);return hm.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const i=fv(e.unaryFilter.field);return hm.create(i,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":default:return mg()}}function mv(e){const t=[];return e.fields.forEach((e=>t.push(e.canonicalString()))),{fieldPaths:t}}function yv(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vv{constructor(){this.promise=new Promise(((e,t)=>{this.resolve=e,this.reject=t}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bv{constructor(e,t,n,r){this.batchId=e,this.localWriteTime=t,this.baseMutations=n,this.mutations=r}applyToRemoteDocument(e,t){const n=t.mutationResults;for(let r=0;r<this.mutations.length;r++){const t=this.mutations[r];t.key.isEqual(e.key)&&iy(t,e,n[r])}}applyToLocalView(e){for(const t of this.baseMutations)t.key.isEqual(e.key)&&sy(t,e,this.localWriteTime);for(const t of this.mutations)t.key.isEqual(e.key)&&sy(t,e,this.localWriteTime)}applyToLocalDocumentSet(e){this.mutations.forEach((t=>{const n=e.get(t.key),r=n;this.applyToLocalView(r),n.isValidDocument()||r.convertToNoDocument(Ig.min())}))}keys(){return this.mutations.reduce(((e,t)=>e.add(t.key)),Oy())}isEqual(e){return this.batchId===e.batchId&&Eg(this.mutations,e.mutations,((e,t)=>ay(e,t)))&&Eg(this.baseMutations,e.baseMutations,((e,t)=>ay(e,t)))}}class Ev{constructor(e,t,n,r){this.batch=e,this.commitVersion=t,this.mutationResults=n,this.docVersions=r}static from(e,t,n){yg(e.mutations.length===n.length);let r=Ry;const i=e.mutations;for(let s=0;s<i.length;s++)r=r.insert(i[s].key,n[s].version);return new Ev(e,t,n,r)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tv{constructor(e,t,n,r,i=Ig.min(),s=Ig.min(),o=xg.EMPTY_BYTE_STRING){this.target=e,this.targetId=t,this.purpose=n,this.sequenceNumber=r,this.snapshotVersion=i,this.lastLimboFreeSnapshotVersion=s,this.resumeToken=o}withSequenceNumber(e){return new Tv(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken)}withResumeToken(e,t){return new Tv(this.target,this.targetId,this.purpose,this.sequenceNumber,t,this.lastLimboFreeSnapshotVersion,e)}withLastLimboFreeSnapshotVersion(e){return new Tv(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iv{constructor(e){this.Lt=e}}function Sv(e){const t=ov({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?function(e,t,n){return new km(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kv{constructor(){this.Bt=new Av}addToCollectionParentIndex(e,t){return this.Bt.add(t),wv.resolve()}getCollectionParents(e,t){return wv.resolve(this.Bt.getEntries(t))}}class Av{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t]||new Ty(Rg.comparator),i=!r.has(n);return this.index[t]=r.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t];return r&&r.has(n)}getEntries(e){return(this.index[e]||new Ty(Rg.comparator)).toArray()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cv{constructor(e){this.Ht=e}next(){return this.Ht+=2,this.Ht}static Jt(){return new Cv(0)}static Yt(){return new Cv(-1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rv(e){if(e.code!==cg.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;dg("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ov{constructor(e,t,n){this.qe=e,this._n=t,this.qt=n}mn(e,t){return this._n.getAllMutationBatchesAffectingDocumentKey(e,t).next((n=>this.gn(e,t,n)))}gn(e,t,n){return this.qe.getEntry(e,t).next((e=>{for(const t of n)t.applyToLocalView(e);return e}))}yn(e,t){e.forEach(((e,n)=>{for(const r of t)r.applyToLocalView(n)}))}pn(e,t){return this.qe.getEntries(e,t).next((t=>this.En(e,t).next((()=>t))))}En(e,t){return this._n.getAllMutationBatchesAffectingDocumentKeys(e,t).next((e=>this.yn(t,e)))}getDocumentsMatchingQuery(e,t,n){return r=t,$g.isDocumentKey(r.path)&&null===r.collectionGroup&&0===r.filters.length?this.Tn(e,t.path):function(e){return null!==e.collectionGroup}(t)?this.In(e,t,n):this.An(e,t,n);var r}Tn(e,t){return this.mn(e,new $g(t)).next((e=>{let t=Cy();return e.isFoundDocument()&&(t=t.insert(e.key,e)),t}))}In(e,t,n){const r=t.collectionGroup;let i=Cy();return this.qt.getCollectionParents(e,r).next((s=>wv.forEach(s,(s=>{const o=(a=t,c=s.child(r),new km(c,null,a.explicitOrderBy.slice(),a.filters.slice(),a.limit,a.limitType,a.startAt,a.endAt));var a,c;return this.An(e,o,n).next((e=>{e.forEach(((e,t)=>{i=i.insert(e,t)}))}))})).next((()=>i))))}An(e,t,n){let r,i;return this.qe.getDocumentsMatchingQuery(e,t,n).next((n=>(r=n,this._n.getAllMutationBatchesAffectingQuery(e,t)))).next((t=>(i=t,this.Rn(e,i,r).next((e=>{r=e;for(const t of i)for(const e of t.mutations){const n=e.key;let i=r.get(n);null==i&&(i=sm.newInvalidDocument(n),r=r.insert(n,i)),sy(e,i,t.localWriteTime),i.isFoundDocument()||(r=r.remove(n))}}))))).next((()=>(r.forEach(((e,n)=>{Pm(t,n)||(r=r.remove(e))})),r)))}Rn(e,t,n){let r=Oy();for(const s of t)for(const e of s.mutations)e instanceof uy&&null===n.get(e.key)&&(r=r.add(e.key));let i=n;return this.qe.getEntries(e,r).next((e=>(e.forEach(((e,t)=>{t.isFoundDocument()&&(i=i.insert(e,t))})),i)))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dv{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Pn=n,this.bn=r}static vn(e,t){let n=Oy(),r=Oy();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new Dv(e,t.fromCache,n,r)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xv{Vn(e){this.Sn=e}getDocumentsMatchingQuery(e,t,n,r){return 0===(i=t).filters.length&&null===i.limit&&null==i.startAt&&null==i.endAt&&(0===i.explicitOrderBy.length||1===i.explicitOrderBy.length&&i.explicitOrderBy[0].field.isKeyField())||n.isEqual(Ig.min())?this.Dn(e,t):this.Sn.pn(e,r).next((i=>{const s=this.Cn(t,i);return(Cm(t)||Rm(t))&&this.Nn(t.limitType,s,r,n)?this.Dn(e,t):(hg()<=Yo.DEBUG&&dg("QueryEngine","Re-using previous result from %s to execute query: %s",n.toString(),Lm(t)),this.Sn.getDocumentsMatchingQuery(e,t,n).next((e=>(s.forEach((t=>{e=e.insert(t.key,t)})),e))))}));var i}Cn(e,t){let n=new Ty(Mm(e));return t.forEach(((t,r)=>{Pm(e,r)&&(n=n.add(r))})),n}Nn(e,t,n,r){if(n.size!==t.size)return!0;const i="F"===e?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Dn(e,t){return hg()<=Yo.DEBUG&&dg("QueryEngine","Using full collection scan to execute query:",Lm(t)),this.Sn.getDocumentsMatchingQuery(e,t,Ig.min())}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lv{constructor(e,t,n,r){this.persistence=e,this.xn=t,this.R=r,this.kn=new _y(bg),this.$n=new Nv((e=>cm(e)),lm),this.On=Ig.min(),this._n=e.getMutationQueue(n),this.Fn=e.getRemoteDocumentCache(),this.Ue=e.getTargetCache(),this.Mn=new Ov(this.Fn,this._n,this.persistence.getIndexManager()),this.Ke=e.getBundleCache(),this.xn.Vn(this.Mn)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.kn)))}}async function Pv(e,t){const n=vg(e);let r=n._n,i=n.Mn;const s=await n.persistence.runTransaction("Handle user change","readonly",(e=>{let s;return n._n.getAllMutationBatches(e).next((o=>(s=o,r=n.persistence.getMutationQueue(t),i=new Ov(n.Fn,r,n.persistence.getIndexManager()),r.getAllMutationBatches(e)))).next((t=>{const n=[],r=[];let o=Oy();for(const e of s){n.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}for(const e of t){r.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}return i.pn(e,o).next((e=>({Ln:e,removedBatchIds:n,addedBatchIds:r})))}))}));return n._n=r,n.Mn=i,n.xn.Vn(n.Mn),s}function Mv(e){const t=vg(e);return t.persistence.runTransaction("Get last remote snapshot version","readonly",(e=>t.Ue.getLastRemoteSnapshotVersion(e)))}function Uv(e,t){const n=vg(e),r=t.snapshotVersion;let i=n.kn;return n.persistence.runTransaction("Apply remote event","readwrite-primary",(e=>{const s=n.Fn.newChangeBuffer({trackRemovals:!0});i=n.kn;const o=[];t.targetChanges.forEach(((t,s)=>{const a=i.get(s);if(!a)return;o.push(n.Ue.removeMatchingKeys(e,t.removedDocuments,s).next((()=>n.Ue.addMatchingKeys(e,t.addedDocuments,s))));const c=t.resumeToken;if(c.approximateByteSize()>0){const d=a.withResumeToken(c,r).withSequenceNumber(e.currentSequenceNumber);i=i.insert(s,d),l=a,h=t,yg((u=d).resumeToken.approximateByteSize()>0),(0===l.resumeToken.approximateByteSize()||u.snapshotVersion.toMicroseconds()-l.snapshotVersion.toMicroseconds()>=3e8||h.addedDocuments.size+h.modifiedDocuments.size+h.removedDocuments.size>0)&&o.push(n.Ue.updateTargetData(e,d))}var l,u,h}));let a=ky();if(t.documentUpdates.forEach(((r,i)=>{t.resolvedLimboDocuments.has(r)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(e,r))})),o.push(function(e,t,n,r,i){let s=Oy();return n.forEach((e=>s=s.add(e))),t.getEntries(e,s).next((e=>{let s=ky();return n.forEach(((n,o)=>{const a=e.get(n),c=(null==i?void 0:i.get(n))||r;o.isNoDocument()&&o.version.isEqual(Ig.min())?(t.removeEntry(n,c),s=s.insert(n,o)):!a.isValidDocument()||o.version.compareTo(a.version)>0||0===o.version.compareTo(a.version)&&a.hasPendingWrites?(t.addEntry(o,c),s=s.insert(n,o)):dg("LocalStore","Ignoring outdated watch update for ",n,". Current version:",a.version," Watch version:",o.version)})),s}))}(e,s,t.documentUpdates,r,void 0).next((e=>{a=e}))),!r.isEqual(Ig.min())){const t=n.Ue.getLastRemoteSnapshotVersion(e).next((t=>n.Ue.setTargetsMetadata(e,e.currentSequenceNumber,r)));o.push(t)}return wv.waitFor(o).next((()=>s.apply(e))).next((()=>n.Mn.En(e,a))).next((()=>a))})).then((e=>(n.kn=i,e)))}function Fv(e,t){const n=vg(e);return n.persistence.runTransaction("Get next mutation batch","readonly",(e=>(void 0===t&&(t=-1),n._n.getNextMutationBatchAfterBatchId(e,t))))}async function Vv(e,t,n){const r=vg(e),i=r.kn.get(t),s=n?"readwrite":"readwrite-primary";try{n||await r.persistence.runTransaction("Release target",s,(e=>r.persistence.referenceDelegate.removeTarget(e,i)))}catch(o){if(!_v(o))throw o;dg("LocalStore",`Failed to update sequence numbers for target ${t}: ${o}`)}r.kn=r.kn.remove(t),r.$n.delete(i.target)}function jv(e,t,n){const r=vg(e);let i=Ig.min(),s=Oy();return r.persistence.runTransaction("Execute query","readonly",(e=>function(e,t,n){const r=vg(e),i=r.$n.get(n);return void 0!==i?wv.resolve(r.kn.get(i)):r.Ue.getTargetData(t,n)}(r,e,Om(t)).next((t=>{if(t)return i=t.lastLimboFreeSnapshotVersion,r.Ue.getMatchingKeysForTargetId(e,t.targetId).next((e=>{s=e}))})).next((()=>r.xn.getDocumentsMatchingQuery(e,t,n?i:Ig.min(),n?s:Oy()))).next((e=>({documents:e,Bn:s})))))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bv{constructor(e){this.R=e,this.jn=new Map,this.Qn=new Map}getBundleMetadata(e,t){return wv.resolve(this.jn.get(t))}saveBundleMetadata(e,t){var n;return this.jn.set(t.id,{id:(n=t).id,version:n.version,createTime:Xy(n.createTime)}),wv.resolve()}getNamedQuery(e,t){return wv.resolve(this.Qn.get(t))}saveNamedQuery(e,t){return this.Qn.set(t.name,{name:(n=t).name,query:Sv(n.bundledQuery),readTime:Xy(n.readTime)}),wv.resolve();var n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qv{constructor(){this.Wn=new Ty($v.Gn),this.zn=new Ty($v.Hn)}isEmpty(){return this.Wn.isEmpty()}addReference(e,t){const n=new $v(e,t);this.Wn=this.Wn.add(n),this.zn=this.zn.add(n)}Jn(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.Yn(new $v(e,t))}Xn(e,t){e.forEach((e=>this.removeReference(e,t)))}Zn(e){const t=new $g(new Rg([])),n=new $v(t,e),r=new $v(t,e+1),i=[];return this.zn.forEachInRange([n,r],(e=>{this.Yn(e),i.push(e.key)})),i}ts(){this.Wn.forEach((e=>this.Yn(e)))}Yn(e){this.Wn=this.Wn.delete(e),this.zn=this.zn.delete(e)}es(e){const t=new $g(new Rg([])),n=new $v(t,e),r=new $v(t,e+1);let i=Oy();return this.zn.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new $v(e,0),n=this.Wn.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class $v{constructor(e,t){this.key=e,this.ns=t}static Gn(e,t){return $g.comparator(e.key,t.key)||bg(e.ns,t.ns)}static Hn(e,t){return bg(e.ns,t.ns)||$g.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zv{constructor(e,t){this.qt=e,this.referenceDelegate=t,this._n=[],this.ss=1,this.rs=new Ty($v.Gn)}checkEmpty(e){return wv.resolve(0===this._n.length)}addMutationBatch(e,t,n,r){const i=this.ss;this.ss++,this._n.length>0&&this._n[this._n.length-1];const s=new bv(i,t,n,r);this._n.push(s);for(const o of r)this.rs=this.rs.add(new $v(o.key,i)),this.qt.addToCollectionParentIndex(e,o.key.path.popLast());return wv.resolve(s)}lookupMutationBatch(e,t){return wv.resolve(this.os(t))}getNextMutationBatchAfterBatchId(e,t){const n=t+1,r=this.cs(n),i=r<0?0:r;return wv.resolve(this._n.length>i?this._n[i]:null)}getHighestUnacknowledgedBatchId(){return wv.resolve(0===this._n.length?-1:this.ss-1)}getAllMutationBatches(e){return wv.resolve(this._n.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const n=new $v(t,0),r=new $v(t,Number.POSITIVE_INFINITY),i=[];return this.rs.forEachInRange([n,r],(e=>{const t=this.os(e.ns);i.push(t)})),wv.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new Ty(bg);return t.forEach((e=>{const t=new $v(e,0),r=new $v(e,Number.POSITIVE_INFINITY);this.rs.forEachInRange([t,r],(e=>{n=n.add(e.ns)}))})),wv.resolve(this.us(n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,r=n.length+1;let i=n;$g.isDocumentKey(i)||(i=i.child(""));const s=new $v(new $g(i),0);let o=new Ty(bg);return this.rs.forEachWhile((e=>{const t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(o=o.add(e.ns)),!0)}),s),wv.resolve(this.us(o))}us(e){const t=[];return e.forEach((e=>{const n=this.os(e);null!==n&&t.push(n)})),t}removeMutationBatch(e,t){yg(0===this.hs(t.batchId,"removed")),this._n.shift();let n=this.rs;return wv.forEach(t.mutations,(r=>{const i=new $v(r.key,t.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)})).next((()=>{this.rs=n}))}Gt(e){}containsKey(e,t){const n=new $v(t,0),r=this.rs.firstAfterOrEqual(n);return wv.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this._n.length,wv.resolve()}hs(e,t){return this.cs(e)}cs(e){return 0===this._n.length?0:e-this._n[0].batchId}os(e){const t=this.cs(e);return t<0||t>=this._n.length?null:this._n[t]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hv{constructor(e,t){this.qt=e,this.ls=t,this.docs=new _y($g.comparator),this.size=0}addEntry(e,t,n){const r=t.key,i=this.docs.get(r),s=i?i.size:0,o=this.ls(t);return this.docs=this.docs.insert(r,{document:t.clone(),size:o,readTime:n}),this.size+=o-s,this.qt.addToCollectionParentIndex(e,r.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const n=this.docs.get(t);return wv.resolve(n?n.document.clone():sm.newInvalidDocument(t))}getEntries(e,t){let n=ky();return t.forEach((e=>{const t=this.docs.get(e);n=n.insert(e,t?t.document.clone():sm.newInvalidDocument(e))})),wv.resolve(n)}getDocumentsMatchingQuery(e,t,n){let r=ky();const i=new $g(t.path.child("")),s=this.docs.getIteratorFrom(i);for(;s.hasNext();){const{key:e,value:{document:i,readTime:o}}=s.getNext();if(!t.path.isPrefixOf(e.path))break;o.compareTo(n)<=0||Pm(t,i)&&(r=r.insert(i.key,i.clone()))}return wv.resolve(r)}fs(e,t){return wv.forEach(this.docs,(e=>t(e)))}newChangeBuffer(e){return new Kv(this)}getSize(e){return wv.resolve(this.size)}}class Kv extends class{constructor(){this.changes=new Nv((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}getReadTime(e){const t=this.changes.get(e);return t?t.readTime:Ig.min()}addEntry(e,t){this.assertNotApplied(),this.changes.set(e.key,{document:e,readTime:t})}removeEntry(e,t=null){this.assertNotApplied(),this.changes.set(e,{document:sm.newInvalidDocument(e),readTime:t})}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?wv.resolve(n.document):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}{constructor(e){super(),this.Ie=e}applyChanges(e){const t=[];return this.changes.forEach(((n,r)=>{r.document.isValidDocument()?t.push(this.Ie.addEntry(e,r.document,this.getReadTime(n))):this.Ie.removeEntry(n)})),wv.waitFor(t)}getFromCache(e,t){return this.Ie.getEntry(e,t)}getAllFromCache(e,t){return this.Ie.getEntries(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wv{constructor(e){this.persistence=e,this.ds=new Nv((e=>cm(e)),lm),this.lastRemoteSnapshotVersion=Ig.min(),this.highestTargetId=0,this.ws=0,this._s=new qv,this.targetCount=0,this.gs=Cv.Jt()}forEachTarget(e,t){return this.ds.forEach(((e,n)=>t(n))),wv.resolve()}getLastRemoteSnapshotVersion(e){return wv.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return wv.resolve(this.ws)}allocateTargetId(e){return this.highestTargetId=this.gs.next(),wv.resolve(this.highestTargetId)}setTargetsMetadata(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.ws&&(this.ws=t),wv.resolve()}te(e){this.ds.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this.gs=new Cv(t),this.highestTargetId=t),e.sequenceNumber>this.ws&&(this.ws=e.sequenceNumber)}addTargetData(e,t){return this.te(t),this.targetCount+=1,wv.resolve()}updateTargetData(e,t){return this.te(t),wv.resolve()}removeTargetData(e,t){return this.ds.delete(t.target),this._s.Zn(t.targetId),this.targetCount-=1,wv.resolve()}removeTargets(e,t,n){let r=0;const i=[];return this.ds.forEach(((s,o)=>{o.sequenceNumber<=t&&null===n.get(o.targetId)&&(this.ds.delete(s),i.push(this.removeMatchingKeysForTargetId(e,o.targetId)),r++)})),wv.waitFor(i).next((()=>r))}getTargetCount(e){return wv.resolve(this.targetCount)}getTargetData(e,t){const n=this.ds.get(t)||null;return wv.resolve(n)}addMatchingKeys(e,t,n){return this._s.Jn(t,n),wv.resolve()}removeMatchingKeys(e,t,n){this._s.Xn(t,n);const r=this.persistence.referenceDelegate,i=[];return r&&t.forEach((t=>{i.push(r.markPotentiallyOrphaned(e,t))})),wv.waitFor(i)}removeMatchingKeysForTargetId(e,t){return this._s.Zn(t),wv.resolve()}getMatchingKeysForTargetId(e,t){const n=this._s.es(t);return wv.resolve(n)}containsKey(e,t){return wv.resolve(this._s.containsKey(t))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gv{constructor(e,t){var n;this.ys={},this.Ne=new ag(0),this.xe=!1,this.xe=!0,this.referenceDelegate=e(this),this.Ue=new Wv(this),this.qt=new kv,this.qe=(n=this.qt,new Hv(n,(e=>this.referenceDelegate.ps(e)))),this.R=new Iv(t),this.Ke=new Bv(this.R)}start(){return Promise.resolve()}shutdown(){return this.xe=!1,Promise.resolve()}get started(){return this.xe}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.qt}getMutationQueue(e){let t=this.ys[e.toKey()];return t||(t=new zv(this.qt,this.referenceDelegate),this.ys[e.toKey()]=t),t}getTargetCache(){return this.Ue}getRemoteDocumentCache(){return this.qe}getBundleCache(){return this.Ke}runTransaction(e,t,n){dg("MemoryPersistence","Starting transaction:",e);const r=new Xv(this.Ne.next());return this.referenceDelegate.Es(),n(r).next((e=>this.referenceDelegate.Ts(r).next((()=>e)))).toPromise().then((e=>(r.raiseOnCommittedEvent(),e)))}Is(e,t){return wv.or(Object.values(this.ys).map((n=>()=>n.containsKey(e,t))))}}class Xv extends class{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}}{constructor(e){super(),this.currentSequenceNumber=e}}class Qv{constructor(e){this.persistence=e,this.As=new qv,this.Rs=null}static Ps(e){return new Qv(e)}get bs(){if(this.Rs)return this.Rs;throw mg()}addReference(e,t,n){return this.As.addReference(n,t),this.bs.delete(n.toString()),wv.resolve()}removeReference(e,t,n){return this.As.removeReference(n,t),this.bs.add(n.toString()),wv.resolve()}markPotentiallyOrphaned(e,t){return this.bs.add(t.toString()),wv.resolve()}removeTarget(e,t){this.As.Zn(t.targetId).forEach((e=>this.bs.add(e.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next((e=>{e.forEach((e=>this.bs.add(e.toString())))})).next((()=>n.removeTargetData(e,t)))}Es(){this.Rs=new Set}Ts(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return wv.forEach(this.bs,(n=>{const r=$g.fromPath(n);return this.vs(e,r).next((e=>{e||t.removeEntry(r)}))})).next((()=>(this.Rs=null,t.apply(e))))}updateLimboDocument(e,t){return this.vs(e,t).next((e=>{e?this.bs.delete(t.toString()):this.bs.add(t.toString())}))}ps(e){return 0}vs(e,t){return wv.or([()=>wv.resolve(this.As.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Is(e,t)])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yv{constructor(e){this.uid=e}isAuthenticated(){return null!=this.uid}toKey(){return this.isAuthenticated()?"uid:"+this.uid:"anonymous-user"}isEqual(e){return e.uid===this.uid}}Yv.UNAUTHENTICATED=new Yv(null),Yv.GOOGLE_CREDENTIALS=new Yv("google-credentials-uid"),Yv.FIRST_PARTY=new Yv("first-party-uid");class Jv{constructor(){this.activeTargetIds=xy()}Ds(e){this.activeTargetIds=this.activeTargetIds.add(e)}Cs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ss(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Zv{constructor(){this.li=new Jv,this.fi={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e){return this.li.Ds(e),this.fi[e]||"not-current"}updateQueryState(e,t,n){this.fi[e]=t}removeLocalQueryTarget(e){this.li.Cs(e)}isLocalQueryTarget(e){return this.li.activeTargetIds.has(e)}clearQueryState(e){delete this.fi[e]}getAllActiveQueryTargets(){return this.li.activeTargetIds}isActiveQueryTarget(e){return this.li.activeTargetIds.has(e)}start(){return this.li=new Jv,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(){}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tw{constructor(){this.wi=()=>this._i(),this.mi=()=>this.gi(),this.yi=[],this.pi()}di(e){this.yi.push(e)}shutdown(){window.removeEventListener("online",this.wi),window.removeEventListener("offline",this.mi)}pi(){window.addEventListener("online",this.wi),window.addEventListener("offline",this.mi)}_i(){dg("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.yi)e(0)}gi(){dg("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.yi)e(1)}static gt(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery"};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rw{constructor(e){this.Ei=e.Ei,this.Ti=e.Ti}Ii(e){this.Ai=e}Ri(e){this.Pi=e}onMessage(e){this.bi=e}close(){this.Ti()}send(e){this.Ei(e)}vi(){this.Ai()}Vi(e){this.Pi(e)}Si(e){this.bi(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cw{constructor(e,t,n,r,i,s){this.Se=e,this.zi=n,this.Hi=r,this.Ji=i,this.listener=s,this.state=0,this.Yi=0,this.Xi=null,this.stream=null,this.Zi=new aw(e,t)}tr(){return 1===this.state||2===this.state||4===this.state}er(){return 2===this.state}start(){3!==this.state?this.auth():this.nr()}async stop(){this.tr()&&await this.close(0)}sr(){this.state=0,this.Zi.reset()}ir(){this.er()&&null===this.Xi&&(this.Xi=this.Se.enqueueAfterDelay(this.zi,6e4,(()=>this.rr())))}cr(e){this.ur(),this.stream.send(e)}async rr(){if(this.er())return this.close(0)}ur(){this.Xi&&(this.Xi.cancel(),this.Xi=null)}async close(e,t){this.ur(),this.Zi.cancel(),this.Yi++,3!==e?this.Zi.reset():t&&t.code===cg.RESOURCE_EXHAUSTED?(fg(t.toString()),fg("Using maximum backoff delay to prevent overloading the backend."),this.Zi.ji()):t&&t.code===cg.UNAUTHENTICATED&&this.Ji.invalidateToken(),null!==this.stream&&(this.ar(),this.stream.close(),this.stream=null),this.state=e,await this.listener.Ri(t)}ar(){}auth(){this.state=1;const e=this.hr(this.Yi),t=this.Yi;this.Ji.getToken().then((e=>{this.Yi===t&&this.lr(e)}),(t=>{e((()=>{const e=new lg(cg.UNKNOWN,"Fetching auth token failed: "+t.message);return this.dr(e)}))}))}lr(e){const t=this.hr(this.Yi);this.stream=this.wr(e),this.stream.Ii((()=>{t((()=>(this.state=2,this.listener.Ii())))})),this.stream.Ri((e=>{t((()=>this.dr(e)))})),this.stream.onMessage((e=>{t((()=>this.onMessage(e)))}))}nr(){this.state=4,this.Zi.Qi((async()=>{this.state=0,this.start()}))}dr(e){return dg("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(3,e)}hr(e){return t=>{this.Se.enqueueAndForget((()=>this.Yi===e?t():(dg("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class lw extends cw{constructor(e,t,n,r,i){super(e,"listen_stream_connection_backoff","listen_stream_idle",t,n,i),this.R=r}wr(e){return this.Hi.Fi("Listen",e)}onMessage(e){this.Zi.reset();const t=function(e,t){let n;if("targetChange"in t){t.targetChange;const i="NO_CHANGE"===(r=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===r?1:"REMOVE"===r?2:"CURRENT"===r?3:"RESET"===r?4:mg(),s=t.targetChange.targetIds||[],o=function(e,t){return e.I?(yg(void 0===t||"string"==typeof t),xg.fromBase64String(t||"")):(yg(void 0===t||t instanceof Uint8Array),xg.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),a=t.targetChange.cause,c=a&&function(e){const t=void 0===e.code?cg.UNKNOWN:wy(e.code);return new lg(t,e.message||"")}(a);n=new Fy(i,s,o,c||null)}else if("documentChange"in t){t.documentChange;const r=t.documentChange;r.document,r.document.name,r.document.updateTime;const i=Zy(e,r.document.name),s=Xy(r.document.updateTime),o=new rm({mapValue:{fields:r.document.fields}}),a=sm.newFoundDocument(i,s,o),c=r.targetIds||[],l=r.removedTargetIds||[];n=new My(c,l,a.key,a)}else if("documentDelete"in t){t.documentDelete;const r=t.documentDelete;r.document;const i=Zy(e,r.document),s=r.readTime?Xy(r.readTime):Ig.min(),o=sm.newNoDocument(i,s),a=r.removedTargetIds||[];n=new My([],a,o.key,o)}else if("documentRemove"in t){t.documentRemove;const r=t.documentRemove;r.document;const i=Zy(e,r.document),s=r.removedTargetIds||[];n=new My([],s,i,null)}else{if(!("filter"in t))return mg();{t.filter;const e=t.filter;e.targetId;const r=e.count||0,i=new my(r),s=e.targetId;n=new Uy(s,i)}}var r;return n}(this.R,e),n=function(e){if(!("targetChange"in e))return Ig.min();const t=e.targetChange;return t.targetIds&&t.targetIds.length?Ig.min():t.readTime?Xy(t.readTime):Ig.min()}(e);return this.listener._r(t,n)}mr(e){const t={};t.database=tv(this.R),t.addTarget=function(e,t){let n;const r=t.target;return n=um(r)?{documents:iv(e,r)}:{query:sv(e,r)},n.targetId=t.targetId,t.resumeToken.approximateByteSize()>0?n.resumeToken=Wy(e,t.resumeToken):t.snapshotVersion.compareTo(Ig.min())>0&&(n.readTime=Ky(e,t.snapshotVersion.toTimestamp())),n}(this.R,e);const n=function(e,t){const n=function(e,t){switch(t){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return mg()}}(0,t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.R,e);n&&(t.labels=n),this.cr(t)}gr(e){const t={};t.database=tv(this.R),t.removeTarget=e,this.cr(t)}}class uw extends cw{constructor(e,t,n,r,i){super(e,"write_stream_connection_backoff","write_stream_idle",t,n,i),this.R=r,this.yr=!1}get pr(){return this.yr}start(){this.yr=!1,this.lastStreamToken=void 0,super.start()}ar(){this.yr&&this.Er([])}wr(e){return this.Hi.Fi("Write",e)}onMessage(e){if(yg(!!e.streamToken),this.lastStreamToken=e.streamToken,this.yr){this.Zi.reset();const t=function(e,t){return e&&e.length>0?(yg(void 0!==t),e.map((e=>function(e,t){let n=e.updateTime?Xy(e.updateTime):Xy(t);return n.isEqual(Ig.min())&&(n=Xy(t)),new ey(n,e.transformResults||[])}(e,t)))):[]}(e.writeResults,e.commitTime),n=Xy(e.commitTime);return this.listener.Tr(n,t)}return yg(!e.writeResults||0===e.writeResults.length),this.yr=!0,this.listener.Ir()}Ar(){const e={};e.database=tv(this.R),this.cr(e)}Er(e){const t={streamToken:this.lastStreamToken,writes:e.map((e=>function(e,t){let n;if(t instanceof ly)n={update:rv(e,t.key,t.value)};else if(t instanceof py)n={delete:Jy(e,t.key)};else if(t instanceof uy)n={update:rv(e,t.key,t.data),updateMask:mv(t.fieldMask)};else{if(!(t instanceof gy))return mg();n={verify:Jy(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map((e=>function(e,t){const n=t.transform;if(n instanceof Hm)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof Km)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof Gm)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof Qm)return{fieldPath:t.field.canonicalString(),increment:n.A};throw mg()}(0,e)))),t.precondition.isNone||(n.currentDocument=(r=e,void 0!==(i=t.precondition).updateTime?{updateTime:Gy(r,i.updateTime)}:void 0!==i.exists?{exists:i.exists}:mg())),n;var r,i}(this.R,e)))};this.cr(t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hw extends class{}{constructor(e,t,n){super(),this.credentials=e,this.Hi=t,this.R=n,this.Rr=!1}Pr(){if(this.Rr)throw new lg(cg.FAILED_PRECONDITION,"The client has already been terminated.")}Ni(e,t,n){return this.Pr(),this.credentials.getToken().then((r=>this.Hi.Ni(e,t,n,r))).catch((e=>{throw"FirebaseError"===e.name?(e.code===cg.UNAUTHENTICATED&&this.credentials.invalidateToken(),e):new lg(cg.UNKNOWN,e.toString())}))}Oi(e,t,n){return this.Pr(),this.credentials.getToken().then((r=>this.Hi.Oi(e,t,n,r))).catch((e=>{throw"FirebaseError"===e.name?(e.code===cg.UNAUTHENTICATED&&this.credentials.invalidateToken(),e):new lg(cg.UNKNOWN,e.toString())}))}terminate(){this.Rr=!0}}class dw{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.br=0,this.vr=null,this.Vr=!0}Sr(){0===this.br&&(this.Dr("Unknown"),this.vr=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this.vr=null,this.Cr("Backend didn't respond within 10 seconds."),this.Dr("Offline"),Promise.resolve()))))}Nr(e){"Online"===this.state?this.Dr("Unknown"):(this.br++,this.br>=1&&(this.kr(),this.Cr(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.Dr("Offline")))}set(e){this.kr(),this.br=0,"Online"===e&&(this.Vr=!1),this.Dr(e)}Dr(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}Cr(e){const t=`Could not reach Cloud Firestore backend. ${e}\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.Vr?(fg(t),this.Vr=!1):dg("OnlineStateTracker",t)}kr(){null!==this.vr&&(this.vr.cancel(),this.vr=null)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fw{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.$r=[],this.Or=new Map,this.Fr=new Set,this.Mr=[],this.Lr=i,this.Lr.di((e=>{n.enqueueAndForget((async()=>{Ew(this)&&(dg("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=vg(e);t.Fr.add(4),await gw(t),t.Br.set("Unknown"),t.Fr.delete(4),await pw(t)}(this))}))})),this.Br=new dw(n,r)}}async function pw(e){if(Ew(e))for(const t of e.Mr)await t(!0)}async function gw(e){for(const t of e.Mr)await t(!1)}function mw(e,t){const n=vg(e);n.Or.has(t.targetId)||(n.Or.set(t.targetId,t),bw(n)?_w(n):Fw(n).er()&&vw(n,t))}function yw(e,t){const n=vg(e),r=Fw(n);n.Or.delete(t),r.er()&&ww(n,t),0===n.Or.size&&(r.er()?r.ir():Ew(n)&&n.Br.set("Unknown"))}function vw(e,t){e.Ur.q(t.targetId),Fw(e).mr(t)}function ww(e,t){e.Ur.q(t),Fw(e).gr(t)}function _w(e){e.Ur=new jy({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),lt:t=>e.Or.get(t)||null}),Fw(e).start(),e.Br.Sr()}function bw(e){return Ew(e)&&!Fw(e).tr()&&e.Or.size>0}function Ew(e){return 0===vg(e).Fr.size}function Tw(e){e.Ur=void 0}async function Iw(e){e.Or.forEach(((t,n)=>{vw(e,t)}))}async function Sw(e,t){Tw(e),bw(e)?(e.Br.Nr(t),_w(e)):e.Br.set("Unknown")}async function kw(e,t,n){if(e.Br.set("Online"),t instanceof Fy&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.Or.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.Or.delete(r),e.Ur.removeTarget(r))}(e,t)}catch(r){dg("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await Aw(e,r)}else if(t instanceof My?e.Ur.X(t):t instanceof Uy?e.Ur.rt(t):e.Ur.et(t),!n.isEqual(Ig.min()))try{const t=await Mv(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.Ur.ut(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.Or.get(r);i&&e.Or.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((t=>{const n=e.Or.get(t);if(!n)return;e.Or.set(t,n.withResumeToken(xg.EMPTY_BYTE_STRING,n.snapshotVersion)),ww(e,t);const r=new Tv(n.target,t,1,n.sequenceNumber);vw(e,r)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(i){dg("RemoteStore","Failed to raise snapshot:",i),await Aw(e,i)}}async function Aw(e,t,n){if(!_v(t))throw t;e.Fr.add(1),await gw(e),e.Br.set("Offline"),n||(n=()=>Mv(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{dg("RemoteStore","Retrying IndexedDB access"),await n(),e.Fr.delete(1),await pw(e)}))}function Cw(e,t){return t().catch((n=>Aw(e,n,t)))}async function Rw(e){const t=vg(e),n=Vw(t);let r=t.$r.length>0?t.$r[t.$r.length-1].batchId:-1;for(;Nw(t);)try{const e=await Fv(t.localStore,r);if(null===e){0===t.$r.length&&n.ir();break}r=e.batchId,Ow(t,e)}catch(i){await Aw(t,i)}Dw(t)&&xw(t)}function Nw(e){return Ew(e)&&e.$r.length<10}function Ow(e,t){e.$r.push(t);const n=Vw(e);n.er()&&n.pr&&n.Er(t.mutations)}function Dw(e){return Ew(e)&&!Vw(e).tr()&&e.$r.length>0}function xw(e){Vw(e).start()}async function Lw(e){Vw(e).Ar()}async function Pw(e){const t=Vw(e);for(const n of e.$r)t.Er(n.mutations)}async function Mw(e,t,n){const r=e.$r.shift(),i=Ev.from(r,t,n);await Cw(e,(()=>e.remoteSyncer.applySuccessfulWrite(i))),await Rw(e)}async function Uw(e,t){t&&Vw(e).pr&&await async function(e,t){if(function(e){switch(e){case cg.OK:return mg();case cg.CANCELLED:case cg.UNKNOWN:case cg.DEADLINE_EXCEEDED:case cg.RESOURCE_EXHAUSTED:case cg.INTERNAL:case cg.UNAVAILABLE:case cg.UNAUTHENTICATED:return!1;case cg.INVALID_ARGUMENT:case cg.NOT_FOUND:case cg.ALREADY_EXISTS:case cg.PERMISSION_DENIED:case cg.FAILED_PRECONDITION:case cg.ABORTED:case cg.OUT_OF_RANGE:case cg.UNIMPLEMENTED:case cg.DATA_LOSS:return!0;default:return mg()}}(n=t.code)&&n!==cg.ABORTED){const n=e.$r.shift();Vw(e).sr(),await Cw(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await Rw(e)}var n}(e,t),Dw(e)&&xw(e)}function Fw(e){return e.qr||(e.qr=function(e,t,n){const r=vg(e);return r.Pr(),new lw(t,r.Hi,r.credentials,r.R,n)}(e.datastore,e.asyncQueue,{Ii:Iw.bind(null,e),Ri:Sw.bind(null,e),_r:kw.bind(null,e)}),e.Mr.push((async t=>{t?(e.qr.sr(),bw(e)?_w(e):e.Br.set("Unknown")):(await e.qr.stop(),Tw(e))}))),e.qr}function Vw(e){return e.Kr||(e.Kr=function(e,t,n){const r=vg(e);return r.Pr(),new uw(t,r.Hi,r.credentials,r.R,n)}(e.datastore,e.asyncQueue,{Ii:Lw.bind(null,e),Ri:Uw.bind(null,e),Ir:Pw.bind(null,e),Tr:Mw.bind(null,e)}),e.Mr.push((async t=>{t?(e.Kr.sr(),await Rw(e)):(await e.Kr.stop(),e.$r.length>0&&(dg("RemoteStore",`Stopping write stream with ${e.$r.length} pending writes`),e.$r=[]))}))),e.Kr
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class jw{constructor(e,t,n,r,i){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=r,this.removalCallback=i,this.deferred=new vv,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((e=>{}))}static createAndSchedule(e,t,n,r,i){const s=Date.now()+n,o=new jw(e,t,s,r,i);return o.start(n),o}start(e){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new lg(cg.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then((e=>this.deferred.resolve(e)))):Promise.resolve()))}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Bw(e,t){if(fg("AsyncQueue",`${t}: ${e}`),_v(e))return new lg(cg.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $w{constructor(){this.jr=new _y($g.comparator)}track(e){const t=e.doc.key,n=this.jr.get(t);n?0!==e.type&&3===n.type?this.jr=this.jr.insert(t,e):3===e.type&&1!==n.type?this.jr=this.jr.insert(t,{type:n.type,doc:e.doc}):2===e.type&&2===n.type?this.jr=this.jr.insert(t,{type:2,doc:e.doc}):2===e.type&&0===n.type?this.jr=this.jr.insert(t,{type:0,doc:e.doc}):1===e.type&&0===n.type?this.jr=this.jr.remove(t):1===e.type&&2===n.type?this.jr=this.jr.insert(t,{type:1,doc:n.doc}):0===e.type&&1===n.type?this.jr=this.jr.insert(t,{type:2,doc:e.doc}):mg():this.jr=this.jr.insert(t,e)}Qr(){const e=[];return this.jr.inorderTraversal(((t,n)=>{e.push(n)})),e}}class zw{constructor(e,t,n,r,i,s,o,a){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=r,this.mutatedKeys=i,this.fromCache=s,this.syncStateChanged=o,this.excludesMetadataChanges=a}static fromInitialDocuments(e,t,n,r){const i=[];return t.forEach((e=>{i.push({type:0,doc:e})})),new zw(e,t,qw.emptySet(t),i,n,r,!0,!1)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Dm(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let r=0;r<t.length;r++)if(t[r].type!==n[r].type||!t[r].doc.isEqual(n[r].doc))return!1;return!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hw{constructor(){this.Wr=void 0,this.listeners=[]}}class Kw{constructor(){this.queries=new Nv((e=>xm(e)),Dm),this.onlineState="Unknown",this.Gr=new Set}}function Ww(e,t){const n=vg(e);let r=!1;for(const i of t){const e=i.query,t=n.queries.get(e);if(t){for(const e of t.listeners)e.Hr(i)&&(r=!0);t.Wr=i}}r&&Xw(n)}function Gw(e,t,n){const r=vg(e),i=r.queries.get(t);if(i)for(const s of i.listeners)s.onError(n);r.queries.delete(t)}function Xw(e){e.Gr.forEach((e=>{e.next()}))}class Qw{constructor(e,t,n){this.query=e,this.Jr=t,this.Yr=!1,this.Xr=null,this.onlineState="Unknown",this.options=n||{}}Hr(e){if(!this.options.includeMetadataChanges){const t=[];for(const n of e.docChanges)3!==n.type&&t.push(n);e=new zw(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0)}let t=!1;return this.Yr?this.Zr(e)&&(this.Jr.next(e),t=!0):this.eo(e,this.onlineState)&&(this.no(e),t=!0),this.Xr=e,t}onError(e){this.Jr.error(e)}zr(e){this.onlineState=e;let t=!1;return this.Xr&&!this.Yr&&this.eo(this.Xr,e)&&(this.no(this.Xr),t=!0),t}eo(e,t){if(!e.fromCache)return!0;const n="Offline"!==t;return!(this.options.so&&n||e.docs.isEmpty()&&"Offline"!==t)}Zr(e){if(e.docChanges.length>0)return!0;const t=this.Xr&&this.Xr.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}no(e){e=zw.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache),this.Yr=!0,this.Jr.next(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yw{constructor(e){this.key=e}}class Jw{constructor(e){this.key=e}}class Zw{constructor(e,t){this.query=e,this.uo=t,this.ao=null,this.current=!1,this.ho=Oy(),this.mutatedKeys=Oy(),this.lo=Mm(e),this.fo=new qw(this.lo)}get wo(){return this.uo}_o(e,t){const n=t?t.mo:new $w,r=t?t.fo:this.fo;let i=t?t.mutatedKeys:this.mutatedKeys,s=r,o=!1;const a=Cm(this.query)&&r.size===this.query.limit?r.last():null,c=Rm(this.query)&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal(((e,t)=>{const l=r.get(e),u=Pm(this.query,t)?t:null,h=!!l&&this.mutatedKeys.has(l.key),d=!!u&&(u.hasLocalMutations||this.mutatedKeys.has(u.key)&&u.hasCommittedMutations);let f=!1;l&&u?l.data.isEqual(u.data)?h!==d&&(n.track({type:3,doc:u}),f=!0):this.yo(l,u)||(n.track({type:2,doc:u}),f=!0,(a&&this.lo(u,a)>0||c&&this.lo(u,c)<0)&&(o=!0)):!l&&u?(n.track({type:0,doc:u}),f=!0):l&&!u&&(n.track({type:1,doc:l}),f=!0,(a||c)&&(o=!0)),f&&(u?(s=s.add(u),i=d?i.add(e):i.delete(e)):(s=s.delete(e),i=i.delete(e)))})),Cm(this.query)||Rm(this.query))for(;s.size>this.query.limit;){const e=Cm(this.query)?s.last():s.first();s=s.delete(e.key),i=i.delete(e.key),n.track({type:1,doc:e})}return{fo:s,mo:n,Nn:o,mutatedKeys:i}}yo(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n){const r=this.fo;this.fo=e.fo,this.mutatedKeys=e.mutatedKeys;const i=e.mo.Qr();i.sort(((e,t)=>function(e,t){const n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return mg()}};return n(e)-n(t)}(e.type,t.type)||this.lo(e.doc,t.doc))),this.po(n);const s=t?this.Eo():[],o=0===this.ho.size&&this.current?1:0,a=o!==this.ao;return this.ao=o,0!==i.length||a?{snapshot:new zw(this.query,e.fo,r,i,e.mutatedKeys,0===o,a,!1),To:s}:{To:s}}zr(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({fo:this.fo,mo:new $w,mutatedKeys:this.mutatedKeys,Nn:!1},!1)):{To:[]}}Io(e){return!this.uo.has(e)&&!!this.fo.has(e)&&!this.fo.get(e).hasLocalMutations}po(e){e&&(e.addedDocuments.forEach((e=>this.uo=this.uo.add(e))),e.modifiedDocuments.forEach((e=>{})),e.removedDocuments.forEach((e=>this.uo=this.uo.delete(e))),this.current=e.current)}Eo(){if(!this.current)return[];const e=this.ho;this.ho=Oy(),this.fo.forEach((e=>{this.Io(e.key)&&(this.ho=this.ho.add(e.key))}));const t=[];return e.forEach((e=>{this.ho.has(e)||t.push(new Jw(e))})),this.ho.forEach((n=>{e.has(n)||t.push(new Yw(n))})),t}Ao(e){this.uo=e.Bn,this.ho=Oy();const t=this._o(e.documents);return this.applyChanges(t,!0)}Ro(){return zw.fromInitialDocuments(this.query,this.fo,this.mutatedKeys,0===this.ao)}}class e_{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class t_{constructor(e){this.key=e,this.Po=!1}}class n_{constructor(e,t,n,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.bo={},this.vo=new Nv((e=>xm(e)),Dm),this.Vo=new Map,this.So=new Set,this.Do=new _y($g.comparator),this.Co=new Map,this.No=new qv,this.xo={},this.ko=new Map,this.$o=Cv.Yt(),this.onlineState="Unknown",this.Oo=void 0}get isPrimaryClient(){return!0===this.Oo}}async function r_(e,t){const n=function(e){const t=vg(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=o_.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=__.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=c_.bind(null,t),t.bo._r=Ww.bind(null,t.eventManager),t.bo.Mo=Gw.bind(null,t.eventManager),t}(e);let r,i;const s=n.vo.get(t);if(s)r=s.targetId,n.sharedClientState.addLocalQueryTarget(r),i=s.view.Ro();else{const e=await function(e,t){const n=vg(e);return n.persistence.runTransaction("Allocate target","readwrite",(e=>{let r;return n.Ue.getTargetData(e,t).next((i=>i?(r=i,wv.resolve(r)):n.Ue.allocateTargetId(e).next((i=>(r=new Tv(t,i,0,e.currentSequenceNumber),n.Ue.addTargetData(e,r).next((()=>r)))))))})).then((e=>{const r=n.kn.get(e.targetId);return(null===r||e.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.kn=n.kn.insert(e.targetId,e),n.$n.set(t,e.targetId)),e}))}(n.localStore,Om(t)),s=n.sharedClientState.addLocalQueryTarget(e.targetId);r=e.targetId,i=await async function(e,t,n,r){e.Fo=(t,n,r)=>async function(e,t,n,r){let i=t.view._o(n);i.Nn&&(i=await jv(e.localStore,t.query,!1).then((({documents:e})=>t.view._o(e,i))));const s=r&&r.targetChanges.get(t.targetId),o=t.view.applyChanges(i,e.isPrimaryClient,s);return g_(e,t.targetId,o.To),o.snapshot}(e,t,n,r);const i=await jv(e.localStore,t,!0),s=new Zw(t,i.Bn),o=s._o(i.documents),a=Py.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"!==e.onlineState),c=s.applyChanges(o,e.isPrimaryClient,a);g_(e,n,c.To);const l=new e_(t,n,s);return e.vo.set(t,l),e.Vo.has(n)?e.Vo.get(n).push(t):e.Vo.set(n,[t]),c.snapshot}(n,t,r,"current"===s),n.isPrimaryClient&&mw(n.remoteStore,e)}return i}async function i_(e,t){const n=vg(e),r=n.vo.get(t),i=n.Vo.get(r.targetId);if(i.length>1)return n.Vo.set(r.targetId,i.filter((e=>!Dm(e,t)))),void n.vo.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await Vv(n.localStore,r.targetId,!1).then((()=>{n.sharedClientState.clearQueryState(r.targetId),yw(n.remoteStore,r.targetId),f_(n,r.targetId)})).catch(Rv)):(f_(n,r.targetId),await Vv(n.localStore,r.targetId,!0))}async function s_(e,t,n){const r=function(e){const t=vg(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=l_.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=u_.bind(null,t),t}(e);try{const e=await function(e,t){const n=vg(e),r=Tg.now(),i=t.reduce(((e,t)=>e.add(t.key)),Oy());let s;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>n.Mn.pn(e,i).next((i=>{s=i;const o=[];for(const e of t){const t=oy(e,s.get(e.key));null!=t&&o.push(new uy(e.key,t,im(t.value.mapValue),ty.exists(!0)))}return n._n.addMutationBatch(e,r,o,t)})))).then((e=>(e.applyToLocalDocumentSet(s),{batchId:e.batchId,changes:s})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.xo[e.currentUser.toKey()];r||(r=new _y(bg)),r=r.insert(t,n),e.xo[e.currentUser.toKey()]=r}(r,e.batchId,n),await v_(r,e.changes),await Rw(r.remoteStore)}catch(i){const e=Bw(i,"Failed to persist write");n.reject(e)}}async function o_(e,t){const n=vg(e);try{const e=await Uv(n.localStore,t);t.targetChanges.forEach(((e,t)=>{const r=n.Co.get(t);r&&(yg(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1),e.addedDocuments.size>0?r.Po=!0:e.modifiedDocuments.size>0?yg(r.Po):e.removedDocuments.size>0&&(yg(r.Po),r.Po=!1))})),await v_(n,e,t)}catch(r){await Rv(r)}}function a_(e,t,n){const r=vg(e);if(r.isPrimaryClient&&0===n||!r.isPrimaryClient&&1===n){const e=[];r.vo.forEach(((n,r)=>{const i=r.view.zr(t);i.snapshot&&e.push(i.snapshot)})),function(e,t){const n=vg(e);n.onlineState=t;let r=!1;n.queries.forEach(((e,n)=>{for(const i of n.listeners)i.zr(t)&&(r=!0)})),r&&Xw(n)}(r.eventManager,t),e.length&&r.bo._r(e),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function c_(e,t,n){const r=vg(e);r.sharedClientState.updateQueryState(t,"rejected",n);const i=r.Co.get(t),s=i&&i.key;if(s){let e=new _y($g.comparator);e=e.insert(s,sm.newNoDocument(s,Ig.min()));const n=Oy().add(s),i=new Ly(Ig.min(),new Map,new Ty(bg),e,n);await o_(r,i),r.Do=r.Do.remove(s),r.Co.delete(t),y_(r)}else await Vv(r.localStore,t,!1).then((()=>f_(r,t,n))).catch(Rv)}async function l_(e,t){const n=vg(e),r=t.batch.batchId;try{const e=await function(e,t){const n=vg(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(e=>{const r=t.batch.keys(),i=n.Fn.newChangeBuffer({trackRemovals:!0});return function(e,t,n,r){const i=n.batch,s=i.keys();let o=wv.resolve();return s.forEach((e=>{o=o.next((()=>r.getEntry(t,e))).next((t=>{const s=n.docVersions.get(e);yg(null!==s),t.version.compareTo(s)<0&&(i.applyToRemoteDocument(t,n),t.isValidDocument()&&r.addEntry(t,n.commitVersion))}))})),o.next((()=>e._n.removeMutationBatch(t,i)))}(n,e,t,i).next((()=>i.apply(e))).next((()=>n._n.performConsistencyCheck(e))).next((()=>n.Mn.pn(e,r)))}))}(n.localStore,t);d_(n,r,null),h_(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await v_(n,e)}catch(i){await Rv(i)}}async function u_(e,t,n){const r=vg(e);try{const e=await function(e,t){const n=vg(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",(e=>{let r;return n._n.lookupMutationBatch(e,t).next((t=>(yg(null!==t),r=t.keys(),n._n.removeMutationBatch(e,t)))).next((()=>n._n.performConsistencyCheck(e))).next((()=>n.Mn.pn(e,r)))}))}(r.localStore,t);d_(r,t,n),h_(r,t),r.sharedClientState.updateMutationState(t,"rejected",n),await v_(r,e)}catch(i){await Rv(i)}}function h_(e,t){(e.ko.get(t)||[]).forEach((e=>{e.resolve()})),e.ko.delete(t)}function d_(e,t,n){const r=vg(e);let i=r.xo[r.currentUser.toKey()];if(i){const e=i.get(t);e&&(n?e.reject(n):e.resolve(),i=i.remove(t)),r.xo[r.currentUser.toKey()]=i}}function f_(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const r of e.Vo.get(t))e.vo.delete(r),n&&e.bo.Mo(r,n);e.Vo.delete(t),e.isPrimaryClient&&e.No.Zn(t).forEach((t=>{e.No.containsKey(t)||p_(e,t)}))}function p_(e,t){e.So.delete(t.path.canonicalString());const n=e.Do.get(t);null!==n&&(yw(e.remoteStore,n),e.Do=e.Do.remove(t),e.Co.delete(n),y_(e))}function g_(e,t,n){for(const r of n)r instanceof Yw?(e.No.addReference(r.key,t),m_(e,r)):r instanceof Jw?(dg("SyncEngine","Document no longer in limbo: "+r.key),e.No.removeReference(r.key,t),e.No.containsKey(r.key)||p_(e,r.key)):mg()}function m_(e,t){const n=t.key,r=n.path.canonicalString();e.Do.get(n)||e.So.has(r)||(dg("SyncEngine","New document in limbo: "+n),e.So.add(r),y_(e))}function y_(e){for(;e.So.size>0&&e.Do.size<e.maxConcurrentLimboResolutions;){const t=e.So.values().next().value;e.So.delete(t);const n=new $g(Rg.fromString(t)),r=e.$o.next();e.Co.set(r,new t_(n)),e.Do=e.Do.insert(n,r),mw(e.remoteStore,new Tv(Om(Am(n.path)),r,2,ag.o))}}async function v_(e,t,n){const r=vg(e),i=[],s=[],o=[];r.vo.isEmpty()||(r.vo.forEach(((e,a)=>{o.push(r.Fo(a,t,n).then((e=>{if(e){r.isPrimaryClient&&r.sharedClientState.updateQueryState(a.targetId,e.fromCache?"not-current":"current"),i.push(e);const t=Dv.vn(a.targetId,e);s.push(t)}})))})),await Promise.all(o),r.bo._r(i),await async function(e,t){const n=vg(e);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",(e=>wv.forEach(t,(t=>wv.forEach(t.Pn,(r=>n.persistence.referenceDelegate.addReference(e,t.targetId,r))).next((()=>wv.forEach(t.bn,(r=>n.persistence.referenceDelegate.removeReference(e,t.targetId,r)))))))))}catch(r){if(!_v(r))throw r;dg("LocalStore","Failed to update sequence numbers: "+r)}for(const i of t){const e=i.targetId;if(!i.fromCache){const t=n.kn.get(e),r=t.snapshotVersion,i=t.withLastLimboFreeSnapshotVersion(r);n.kn=n.kn.insert(e,i)}}}(r.localStore,s))}async function w_(e,t){const n=vg(e);if(!n.currentUser.isEqual(t)){dg("SyncEngine","User change. New user:",t.toKey());const e=await Pv(n.localStore,t);n.currentUser=t,(r=n).ko.forEach((e=>{e.forEach((e=>{e.reject(new lg(cg.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))}))})),r.ko.clear(),n.sharedClientState.handleUserChange(t,e.removedBatchIds,e.addedBatchIds),await v_(n,e.Ln)}var r}function __(e,t){const n=vg(e),r=n.Co.get(t);if(r&&r.Po)return Oy().add(r.key);{let e=Oy();const r=n.Vo.get(t);if(!r)return e;for(const t of r){const r=n.vo.get(t);e=e.unionWith(r.view.wo)}return e}}class b_{constructor(){this.synchronizeTabs=!1}async initialize(e){this.R=ow(e.databaseInfo.databaseId),this.sharedClientState=this.Bo(e),this.persistence=this.Uo(e),await this.persistence.start(),this.gcScheduler=this.qo(e),this.localStore=this.Ko(e)}qo(e){return null}Ko(e){return function(e,t,n,r){return new Lv(e,t,n,r)}(this.persistence,new xv,e.initialUser,this.R)}Uo(e){return new Gv(Qv.Ps,this.R)}Bo(e){return new Zv}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class E_{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>a_(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=w_.bind(null,this.syncEngine),await async function(e,t){const n=vg(e);t?(n.Fr.delete(2),await pw(n)):t||(n.Fr.add(2),await gw(n),n.Br.set("Unknown"))}(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new Kw}createDatastore(e){const t=ow(e.databaseInfo.databaseId),n=(r=e.databaseInfo,new iw(r));var r,i;return i=e.credentials,new hw(i,n,t)}createRemoteStore(e){return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=e=>a_(this.syncEngine,e,0),s=tw.gt()?new tw:new ew,new fw(t,n,r,i,s);var t,n,r,i,s}createSyncEngine(e,t){return function(e,t,n,r,i,s,o){const a=new n_(e,t,n,r,i,s);return o&&(a.Oo=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){const t=vg(e);dg("RemoteStore","RemoteStore shutting down."),t.Fr.add(5),await gw(t),t.Lr.shutdown(),t.Br.set("Unknown")}(this.remoteStore)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T_{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Qo(this.observer.next,e)}error(e){this.observer.error?this.Qo(this.observer.error,e):console.error("Uncaught Error in snapshot listener:",e)}Wo(){this.muted=!0}Qo(e,t){this.muted||setTimeout((()=>{this.muted||e(t)}),0)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I_{constructor(e,t,n){this.credentials=e,this.asyncQueue=t,this.databaseInfo=n,this.user=Yv.UNAUTHENTICATED,this.clientId=_g.u(),this.credentialListener=()=>Promise.resolve(),this.credentials.setChangeListener(t,(async e=>{dg("FirestoreClient","Received user=",e.uid),await this.credentialListener(e),this.user=e}))}async getConfiguration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,credentials:this.credentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.credentialListener=e}verifyNotTerminated(){if(this.asyncQueue.isShuttingDown)throw new lg(cg.FAILED_PRECONDITION,"The client has already been terminated.")}terminate(){this.asyncQueue.enterRestrictedMode();const e=new vv;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this.onlineComponents&&await this.onlineComponents.terminate(),this.offlineComponents&&await this.offlineComponents.terminate(),this.credentials.removeChangeListener(),e.resolve()}catch(t){const n=Bw(t,"Failed to shutdown persistence");e.reject(n)}})),e.promise}}async function S_(e,t){e.asyncQueue.verifyOperationInProgress();const n=await async function(e){return e.offlineComponents||(dg("FirestoreClient","Using default OfflineComponentProvider"),await async function(e,t){e.asyncQueue.verifyOperationInProgress(),dg("FirestoreClient","Initializing OfflineComponentProvider");const n=await e.getConfiguration();await t.initialize(n);let r=n.initialUser;e.setCredentialChangeListener((async e=>{r.isEqual(e)||(await Pv(t.localStore,e),r=e)})),t.persistence.setDatabaseDeletedListener((()=>e.terminate())),e.offlineComponents=t}(e,new b_)),e.offlineComponents}(e);dg("FirestoreClient","Initializing OnlineComponentProvider");const r=await e.getConfiguration();await t.initialize(n,r),e.setCredentialChangeListener((e=>async function(e,t){const n=vg(e);n.asyncQueue.verifyOperationInProgress(),dg("RemoteStore","RemoteStore received new credentials");const r=Ew(n);n.Fr.add(3),await gw(n),r&&n.Br.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.Fr.delete(3),await pw(n)}(t.remoteStore,e))),e.onlineComponents=t}async function k_(e){return e.onlineComponents||(dg("FirestoreClient","Using default OnlineComponentProvider"),await S_(e,new E_)),e.onlineComponents}async function A_(e){const t=await k_(e),n=t.eventManager;return n.onListen=r_.bind(null,t.syncEngine),n.onUnlisten=i_.bind(null,t.syncEngine),n}function C_(e,t,n={}){const r=new vv;return e.asyncQueue.enqueueAndForget((async()=>function(e,t,n,r,i){const s=new T_({next:n=>{t.enqueueAndForget((()=>async function(e,t){const n=vg(e),r=t.query;let i=!1;const s=n.queries.get(r);if(s){const e=s.listeners.indexOf(t);e>=0&&(s.listeners.splice(e,1),i=0===s.listeners.length)}if(i)return n.queries.delete(r),n.onUnlisten(r)}(e,o))),n.fromCache&&"server"===r.source?i.reject(new lg(cg.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new Qw(n,s,{includeMetadataChanges:!0,so:!0});return async function(t,n){const r=vg(t),i=n.query;let s=!1,o=r.queries.get(i);if(o||(s=!0,o=new Hw),s)try{o.Wr=await r.onListen(i)}catch(e){const r=Bw(e,`Initialization of query '${Lm(n.query)}' failed`);return void n.onError(r)}r.queries.set(i,o),o.listeners.push(n),n.zr(r.onlineState),o.Wr&&n.Hr(o.Wr)&&Xw(r)}(e,o)}(await A_(e),e.asyncQueue,t,n,r))),r.promise}class R_{constructor(e,t,n,r,i,s,o,a){this.databaseId=e,this.appId=t,this.persistenceKey=n,this.host=r,this.ssl=i,this.forceLongPolling=s,this.autoDetectLongPolling=o,this.useFetchStreams=a}}class N_{constructor(e,t){this.projectId=e,this.database=t||"(default)"}get isDefaultDatabase(){return"(default)"===this.database}isEqual(e){return e instanceof N_&&e.projectId===this.projectId&&e.database===this.database}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D_{constructor(e,t){this.user=t,this.type="OAuth",this.authHeaders={},this.authHeaders.Authorization=`Bearer ${e}`}}class x_{constructor(){this.changeListener=null}getToken(){return Promise.resolve(null)}invalidateToken(){}setChangeListener(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(Yv.UNAUTHENTICATED)))}removeChangeListener(){this.changeListener=null}}class L_{constructor(e){this.currentUser=Yv.UNAUTHENTICATED,this.oc=new vv,this.cc=0,this.forceRefresh=!1,this.auth=null,this.asyncQueue=null,this.uc=()=>{this.cc++,this.currentUser=this.ac(),this.oc.resolve(),this.changeListener&&this.asyncQueue.enqueueRetryable((()=>this.changeListener(this.currentUser)))};const t=e=>{dg("FirebaseCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.uc)};e.onInit((e=>t(e))),setTimeout((()=>{if(!this.auth){const n=e.getImmediate({optional:!0});n?t(n):(dg("FirebaseCredentialsProvider","Auth not yet detected"),this.oc.resolve())}}),0)}getToken(){const e=this.cc,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((t=>this.cc!==e?(dg("FirebaseCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(yg("string"==typeof t.accessToken),new D_(t.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}setChangeListener(e,t){this.asyncQueue=e,this.asyncQueue.enqueueRetryable((async()=>{await this.oc.promise,await t(this.currentUser),this.changeListener=t}))}removeChangeListener(){this.auth&&this.auth.removeAuthTokenListener(this.uc),this.changeListener=()=>Promise.resolve()}ac(){const e=this.auth&&this.auth.getUid();return yg(null===e||"string"==typeof e),new Yv(e)}}class P_{constructor(e,t,n){this.hc=e,this.lc=t,this.fc=n,this.type="FirstParty",this.user=Yv.FIRST_PARTY}get authHeaders(){const e={"X-Goog-AuthUser":this.lc},t=this.hc.auth.getAuthHeaderValueForFirstParty([]);return t&&(e.Authorization=t),this.fc&&(e["X-Goog-Iam-Authorization-Token"]=this.fc),e}}class M_{constructor(e,t,n){this.hc=e,this.lc=t,this.fc=n}getToken(){return Promise.resolve(new P_(this.hc,this.lc,this.fc))}setChangeListener(e,t){e.enqueueRetryable((()=>t(Yv.FIRST_PARTY)))}removeChangeListener(){}invalidateToken(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U_(e,t,n){if(!n)throw new lg(cg.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function F_(e){if(!$g.isDocumentKey(e))throw new lg(cg.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function V_(e){if($g.isDocumentKey(e))throw new lg(cg.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function j_(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{const t=function(e){if(e.constructor){const t=/function\s+([^\s(]+)\s*\(/.exec(e.constructor.toString());if(t&&t.length>1)return t[1]}return null}(e);return t?`a custom ${t} object`:"an object"}}return"function"==typeof e?"a function":mg()}function B_(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new lg(cg.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=j_(e);throw new lg(cg.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $_{constructor(e,t){this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new q_({}),this._settingsFrozen=!1,e instanceof N_?(this._databaseId=e,this._credentials=new x_):(this._app=e,this._databaseId=function(e){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new lg(cg.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new N_(e.options.projectId)}(e),this._credentials=new L_(t))}get app(){if(!this._app)throw new lg(cg.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return void 0!==this._terminateTask}_setSettings(e){if(this._settingsFrozen)throw new lg(cg.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new q_(e),void 0!==e.credentials&&(this._credentials=function(e){if(!e)return new x_;switch(e.type){case"gapi":const t=e.client;return yg(!("object"!=typeof t||null===t||!t.auth||!t.auth.getAuthHeaderValueForFirstParty)),new M_(t,e.sessionIndex||"0",e.iamToken||null);case"provider":return e.client;default:throw new lg(cg.INVALID_ARGUMENT,"makeCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const t=O_.get(e);t&&(dg("ComponentProvider","Removing Datastore"),O_.delete(e),t.terminate())}(this),Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z_{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new K_(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new z_(this.firestore,e,this._key)}}class H_{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new H_(this.firestore,e,this._query)}}class K_ extends H_{constructor(e,t,n){super(e,t,Am(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new z_(this.firestore,null,new $g(e))}withConverter(e){return new K_(this.firestore,e,this._path)}}function W_(e,t,...n){if(e=Wo(e),U_("collection","path",t),e instanceof $_){const r=Rg.fromString(t,...n);return V_(r),new K_(e,null,r)}{if(!(e instanceof z_||e instanceof K_))throw new lg(cg.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=Rg.fromString(e.path,...n).child(Rg.fromString(t));return V_(r),new K_(e.firestore,null,r)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class G_{constructor(){this.dc=Promise.resolve(),this.wc=[],this._c=!1,this.mc=[],this.gc=null,this.yc=!1,this.Ec=!1,this.Tc=[],this.Zi=new aw(this,"async_queue_retry"),this.Ic=()=>{const e=sw();e&&dg("AsyncQueue","Visibility state changed to "+e.visibilityState),this.Zi.Gi()};const e=sw();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.Ic)}get isShuttingDown(){return this._c}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Ac(),this.Rc(e)}enterRestrictedMode(e){if(!this._c){this._c=!0,this.Ec=e||!1;const t=sw();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.Ic)}}enqueue(e){if(this.Ac(),this._c)return new Promise((()=>{}));const t=new vv;return this.Rc((()=>this._c&&this.Ec?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.wc.push(e),this.Pc())))}async Pc(){if(0!==this.wc.length){try{await this.wc[0](),this.wc.shift(),this.Zi.reset()}catch(e){if(!_v(e))throw e;dg("AsyncQueue","Operation failed with retryable error: "+e)}this.wc.length>0&&this.Zi.Qi((()=>this.Pc()))}}Rc(e){const t=this.dc.then((()=>(this.yc=!0,e().catch((e=>{throw this.gc=e,this.yc=!1,fg("INTERNAL UNHANDLED ERROR: ",function(e){let t=e.message||"";return e.stack&&(t=e.stack.includes(e.message)?e.stack:e.message+"\n"+e.stack),t}(e)),e})).then((e=>(this.yc=!1,e))))));return this.dc=t,t}enqueueAfterDelay(e,t,n){this.Ac(),this.Tc.indexOf(e)>-1&&(t=0);const r=jw.createAndSchedule(this,e,t,n,(e=>this.bc(e)));return this.mc.push(r),r}Ac(){this.gc&&mg()}verifyOperationInProgress(){}async vc(){let e;do{e=this.dc,await e}while(e!==this.dc)}Vc(e){for(const t of this.mc)if(t.timerId===e)return!0;return!1}Sc(e){return this.vc().then((()=>{this.mc.sort(((e,t)=>e.targetTimeMs-t.targetTimeMs));for(const t of this.mc)if(t.skipDelay(),"all"!==e&&t.timerId===e)break;return this.vc()}))}Dc(e){this.Tc.push(e)}bc(e){const t=this.mc.indexOf(e);this.mc.splice(t,1)}}class X_ extends $_{constructor(e,t){super(e,t),this.type="firestore",this._queue=new G_,this._persistenceKey="name"in e?e.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||J_(this),this._firestoreClient.terminate()}}function Q_(e=ya()){return fa(e,"firestore-exp").getImmediate()}function Y_(e){return e._firestoreClient||J_(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function J_(e){var t;const n=e._freezeSettings(),r=(i=e._databaseId,s=(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",o=e._persistenceKey,new R_(i,s,o,(a=n).host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams));var i,s,o,a;e._firestoreClient=new I_(e._credentials,e._queue,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z_{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new lg(cg.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Og(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eb{constructor(e){this._byteString=e}static fromBase64String(e){try{return new eb(xg.fromBase64String(e))}catch(t){throw new lg(cg.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new eb(xg.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nb{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new lg(cg.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new lg(cg.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return bg(this._lat,e._lat)||bg(this._long,e._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rb=/^__.*__$/;class ib{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new uy(e,this.data,this.fieldMask,t,this.fieldTransforms):new ly(e,this.data,t,this.fieldTransforms)}}function sb(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw mg()}}class ob{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.R=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Cc(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Nc(){return this.settings.Nc}xc(e){return new ob(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.R,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}kc(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.xc({path:n,$c:!1});return r.Oc(e),r}Fc(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.xc({path:n,$c:!1});return r.Cc(),r}Mc(e){return this.xc({path:void 0,$c:!0})}Lc(e){return vb(e,this.settings.methodName,this.settings.Bc||!1,this.path,this.settings.Uc)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}Cc(){if(this.path)for(let e=0;e<this.path.length;e++)this.Oc(this.path.get(e))}Oc(e){if(0===e.length)throw this.Lc("Document fields must not be empty");if(sb(this.Nc)&&rb.test(e))throw this.Lc('Document fields cannot begin and end with "__"')}}class ab{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.R=n||ow(e)}qc(e,t,n,r=!1){return new ob({Nc:e,methodName:t,Uc:n,path:Og.emptyPath(),$c:!1,Bc:r},this.databaseId,this.R,this.ignoreUndefinedProperties)}}function cb(e){const t=e._freezeSettings(),n=ow(e._databaseId);return new ab(e._databaseId,!!t.ignoreUndefinedProperties,n)}function lb(e,t,n,r,i,s={}){const o=e.qc(s.merge||s.mergeFields?2:0,t,n,i);pb("Data must be an object, but it was:",o,r);const a=db(r,o);let c,l;if(s.merge)c=new Dg(o.fieldMask),l=o.fieldTransforms;else if(s.mergeFields){const e=[];for(const r of s.mergeFields){const i=gb(t,r,n);if(!o.contains(i))throw new lg(cg.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);wb(e,i)||e.push(i)}c=new Dg(e),l=o.fieldTransforms.filter((e=>c.covers(e.field)))}else c=null,l=o.fieldTransforms;return new ib(new rm(a),c,l)}class ub extends tb{_toFieldTransform(e){return new Zm(e.path,new Hm)}isEqual(e){return e instanceof ub}}function hb(e,t){if(fb(e=Wo(e)))return pb("Unsupported field value:",t,e),db(e,t);if(e instanceof tb)return function(e,t){if(!sb(t.Nc))throw t.Lc(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Lc(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.$c&&4!==t.Nc)throw t.Lc("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=hb(i,t.Mc(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=Wo(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return jm(t.R,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=Tg.fromDate(e);return{timestampValue:Ky(t.R,n)}}if(e instanceof Tg){const n=new Tg(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Ky(t.R,n)}}if(e instanceof nb)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof eb)return{bytesValue:Wy(t.R,e._byteString)};if(e instanceof z_){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.Lc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Qy(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.Lc(`Unsupported field value: ${j_(e)}`)}(e,t)}function db(e,t){const n={};return Ag(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):kg(e,((e,r)=>{const i=hb(r,t.kc(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function fb(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof Tg||e instanceof nb||e instanceof eb||e instanceof z_||e instanceof tb)}function pb(e,t,n){if(!fb(n)||("object"!=typeof(r=n)||null===r||Object.getPrototypeOf(r)!==Object.prototype&&null!==Object.getPrototypeOf(r))){const r=j_(n);throw"an object"===r?t.Lc(e+" a custom object"):t.Lc(e+" "+r)}var r}function gb(e,t,n){if((t=Wo(t))instanceof Z_)return t._internalPath;if("string"==typeof t)return yb(e,t);throw vb("Field path arguments must be of type string or FieldPath.",e,!1,void 0,n)}const mb=new RegExp("[~\\*/\\[\\]]");function yb(e,t,n){if(t.search(mb)>=0)throw vb(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Z_(...t.split("."))._internalPath}catch(r){throw vb(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function vb(e,t,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${r}`),o&&(c+=` in document ${i}`),c+=")"),new lg(cg.INVALID_ARGUMENT,a+e+c)}function wb(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _b{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new z_(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new bb(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Eb("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class bb extends _b{data(){return super.data()}}function Eb(e,t){return"string"==typeof t?yb(e,t):t instanceof Z_?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tb{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Ib extends _b{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Sb(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(Eb("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class Sb extends Ib{data(e={}){return super.data(e)}}class kb{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new Tb(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach((n=>{e.call(t,new Sb(this._firestore,this._userDataWriter,n.key,n,new Tb(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new lg(cg.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map((n=>({type:"added",doc:new Sb(e._firestore,e._userDataWriter,n.doc.key,n.doc,new Tb(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter),oldIndex:-1,newIndex:t++})))}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((e=>t||3!==e.type)).map((t=>{const r=new Sb(e._firestore,e._userDataWriter,t.doc.key,t.doc,new Tb(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),s=n.indexOf(t.doc.key)),{type:Ab(t.type),doc:r,oldIndex:i,newIndex:s}}))}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function Ab(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return mg()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */{constructor(e){super(),this.firestore=e}convertBytes(e){return new eb(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new z_(this.firestore,null,t)}}function Rb(e){e=B_(e,H_);const t=B_(e.firestore,X_),n=Y_(t),r=new Cb(t);return function(e){if(Rm(e)&&0===e.explicitOrderBy.length)throw new lg(cg.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),C_(n,e._query).then((n=>new kb(t,r,e,n)))}function Nb(e,t){const n=B_(e.firestore,X_),r=function(e,t,...n){if(e=Wo(e),1===arguments.length&&(t=_g.u()),U_("doc","path",t),e instanceof $_){const r=Rg.fromString(t,...n);return F_(r),new z_(e,null,new $g(r))}{if(!(e instanceof z_||e instanceof K_))throw new lg(cg.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(Rg.fromString(t,...n));return F_(r),new z_(e.firestore,e instanceof K_?e.converter:null,new $g(r))}}(e),i=function(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}(e.converter,t);return function(e,t){return function(e,t){const n=new vv;return e.asyncQueue.enqueueAndForget((async()=>s_(await function(e){return k_(e).then((e=>e.syncEngine))}(e),t,n))),n.promise}(Y_(e),t)}(n,[lb(cb(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,ty.exists(!1))]).then((()=>r))}function Ob(){return new ub("serverTimestamp")}og="9.0.0-beta.8",da(new Go("firestore-exp",((e,{options:t})=>{const n=e.getProvider("app-exp").getImmediate(),r=new X_(n,e.getProvider("auth-internal"));return t=Object.assign({useFetchStreams:!0},t),r._setSettings(t),r}),"PUBLIC")),va("@firebase/firestore","0.0.900-exp.8b4d7550f",undefined);export{Ht as A,fr as B,Q_ as C,$u as D,W_ as E,mr as F,ju as G,Bu as H,qu as I,Rb as J,Fr as K,wo as L,Es as M,ct as N,$i as O,Ei as T,zu as a,Er as b,Sr as c,Or as d,$t as e,xr as f,Vl as g,Tn as h,ma as i,Ke as j,st as k,Lr as l,Nb as m,nr as n,Vc as o,qt as p,ji as q,nt as r,Ob as s,c as t,bo as u,Ui as v,zt as w,Uc as x,Fc as y,jc as z};
